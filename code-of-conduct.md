...
Com o intuito de promover um ambiente aberto e acolhedor, a Equipe de Documentação do Adobe - como colaboradores e mantenedores - se compromete a tornar a participação neste projeto e na comunidade uma experiência livre de assédio para todos, independentemente de idade, biotipo, deficiência, etnia, identidade e expressão de gênero, nível de experiência, nacionalidade, aparência pessoal, raça, religião ou identidade e orientação sexual.
...
O presente Código de Conduta é adaptado do [Contrato do colaborador](https://www.contributor-covenant.org/), versão 1.4, disponível em [Código de conduta do pacto do colaborador](https://www.contributor-covenant.org/version/1/4/code-of-conduct/).
