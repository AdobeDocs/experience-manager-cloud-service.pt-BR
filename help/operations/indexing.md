...
Atualmente, o gerenciamento de índice é compatível apenas com índices do tipo `lucene`. Internamente, outros índices podem ser configurados e usados para consultas; por exemplo, índices Elastic.
