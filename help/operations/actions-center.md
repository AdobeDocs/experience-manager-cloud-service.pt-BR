...
| Contagem Alta de Conexões | Proativa | Saiba mais sobre o pool de conexões no [Pool de Conexões juntamente com a documentação avançada de rede](/help/security/configuring-advanced-networking.md#connection-pooling-advanced-networking) |
