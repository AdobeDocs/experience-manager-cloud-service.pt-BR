...
* **O RPO (Recovery Point Objetive, objetivo de ponto de recuperação):** O Objetivo do Ponto de Recuperação depende do tempo de restauração selecionado no passado:
