---
title: Visão geral do Adobe Experience Manager como um serviço em nuvem
description: Adobe Experience Manager como uma visão geral do serviço em nuvem Recursos de autoajuda e links de documentação
...
# Visão geral do Experience Manager como um serviço em nuvem {#aem-overview-guide}

Esta página lista os recursos de autoajuda que apresentam uma introdução e uma visão geral do Experience Manager como um serviço da Cloud.

## Principais artigos de visão geral {#key-articles}

* [Introdução](introduction.md)
* [Terminologia](terminology.md)
* [Novidades e diferentes](what-is-new-and-different.md)
