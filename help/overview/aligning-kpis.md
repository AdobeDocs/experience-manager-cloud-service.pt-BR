...
1. **Comece com seus objetivos comerciais.** Por exemplo, seus objetivos comerciais podem ser aumentar a receita online, diminuir as despesas operacionais ou reduzir as despesas legais associadas às violações do gerenciamento de direitos digitais (DRM).
...
1. **Escolha os três indicadores mais importantes para sua empresa.** Esses são seus KPIs. Eles podem se alinhar com três objetivos de negócios, cada um liderado por um executivo de nível C diferente, ou todos os três KPIs podem suportar o mesmo objetivo, se todos concordarem que é o mais importante.
