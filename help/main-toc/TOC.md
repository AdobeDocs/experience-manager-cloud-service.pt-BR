...
+ Notas de versão {#release-notes}
   ...
   + Notas de versão do Cloud Manager {#cloud-manager}
      ...
      + 2025 {#2025}
         + [Notas da versão 2025.1.0](/help/implementing/cloud-manager/release-notes/2025/2025-1-0.md)
      + 2024 {#2024}
         + [Notas da versão 2024.12.0](/help/implementing/cloud-manager/release-notes/2024/2024-12-0.md)
         + [Notas da versão 2024.11.0](/help/implementing/cloud-manager/release-notes/2024/2024-11-0.md)
         + [Notas da versão 2024.10.0](/help/implementing/cloud-manager/release-notes/2024/2024-10-0.md)
         ...
         + [Notas da versão 2024.5.0](/help/implementing/cloud-manager/release-notes/2024/2024-5-0.md)
         + [Notas da versão 2024.4.0](/help/implementing/cloud-manager/release-notes/2024/2024-4-0.md)
         + [Notas da versão 2024.3.0](/help/implementing/cloud-manager/release-notes/2024/2024-3-0.md)
         + [Notas da versão 2024.2.0](/help/implementing/cloud-manager/release-notes/2024/2024-2-0.md)
...
+ Forms {#forms}
   ...
   + Relatórios de transação {#using-communications}
      ...
      + [Noções básicas sobre seu painel de avaliação de valor](/help/forms/aem-forms-value-realization-dashboard.md)
...
+ Edge Delivery Services {#edge-delivery}
   ...
   + Compilando o Forms {#build-forms}
      ...
      + Criação baseada em documento {#getting-started-edge-delivery-services-forms}
         ...
         + [Implantar o Forms no Edge: Guia de publicação do Edge Delivery Services](/help/edge/docs/forms/publishing-forms.md)
      + Criação no WYSIWYG {#universal-editor}
         ...
         + [Como criar seu primeiro formulário usando o Universal Editor - Tutorial passo a passo](/help/edge/docs/forms/universal-editor/getting-started-universal-editor.md)
   ...
   + Recursos do Edge Delivery {#resources}
      ...
      + [Status do AEM](https://status.adobe.com)
      + Ferramentas {#tools}
...
+ Implementação {#implementing}
   ...
   + Usar o Cloud Manager {#using-cloud-manager}
      ...
      + Configurações da CDN {#cdn-configurations}
         + [Adicionar uma configuração de CDN](/help/implementing/cloud-manager/cdn-configurations/add-cdn-config.md)
         + [Gerenciar configurações de CDN](/help/implementing/cloud-manager/cdn-configurations/manage-cdn-config.md)
