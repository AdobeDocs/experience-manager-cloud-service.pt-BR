...
+ IA no AEM {#ai-in-aem}
   ...
   + Agentes no AEM {#agents}
      ...
      + Brand Experience Agent {#brand-experience}
         ...
         + [Trabalho de desenvolvimento](/help/ai-in-aem/agents/brand-experience/development/development.md)
      + Agente do Supervisor de Conteúdo {#content-advisor}
         + [Visão geral](/help/ai-in-aem/agents/content-advisor/overview.md)
         + [Tarefa de Descoberta de Conteúdo](/help/ai-in-aem/agents/content-advisor/discovery.md)
         + [Trabalho de otimização de conteúdo](/help/ai-in-aem/agents/content-advisor/content-optimization.md)
      ...
      + Agente de modernização de experiência {#modernization}
         + [Visão geral](/help/ai-in-aem/agents/modernization/overview.md)
         + [Introdução](/help/ai-in-aem/agents/modernization/getting-started.md)
         + [Console de Modernização](/help/ai-in-aem/agents/modernization/console.md)
