...
+ Implementação {#implementing}
   ...
   + Usar o Cloud Manager {#using-cloud-manager}
      ...
      + Mapeamentos de domínios {#cdn-configurations}
         + [Adicionar um mapeamento de domínio](/help/implementing/cloud-manager/cdn-configurations/add-cdn-config.md)
         + [Gerenciar Mapeamentos de Domínio](/help/implementing/cloud-manager/cdn-configurations/manage-cdn-config.md)
