...
+ Edge Delivery Services {#edge-delivery}
   ...
   + Criação de Forms {#build-forms}
      ...
      + [Práticas recomendadas para criar formulários](/help/edge/docs/forms/universal-editor/best-pratices-eds-forms.md)
...
+ IA generativa {#generative-ai}
   ...
   + [Assistente de IA para o AEM Forms (Forms Experience Builder) (Usuário inicial)](/help/edge/docs/forms/forms-ai-assistant.md)
