...
+ Forms {#forms}
   ...
   + Comunicação interativa {#interactive-communication}
      ...
      + Componente {#component}
         + [Componente Caixa de texto no Editor de comunicação interativa](/help/forms/interactive-communication/text-box-component-in-interactive-communication-editor.md)
         + [Componente de imagem no Editor de comunicação interativa](/help/forms/interactive-communication/image-component-in-interactive-communication-editor.md)
         + [Componente de Campo de imagem no Editor de comunicação interativa](/help/forms/interactive-communication/image-field-component-in-interactive-communication-editor.md)
         + [Componente Campo de texto no Editor de comunicação interativa](/help/forms/interactive-communication/text-field-component-in-interactive-communication-editor.md)
         + [Componente de campo numérico no editor de comunicação interativa](/help/forms/interactive-communication/numeric-field-component-in-interactive-communication-editor.md)
         + [Componente de Campo de data/hora no Editor de comunicação interativa](/help/forms/interactive-communication/date-time-field-component-in-interactive-communication-editor.md)
         + [Componente de Campo de data no Editor de comunicação interativa](/help/forms/interactive-communication/date-field-component-in-interactive-communication-editor.md)
         + [Componente de Caixa de seleção no Editor de comunicação interativa](/help/forms/interactive-communication/check-box-component-in-interactive-communication-editor.md)
         + [Componente de Botão de opção no Editor de comunicação interativa](/help/forms/interactive-communication/radio-button-component-in-interactive-communication-editor.md)
         + [Componente de Subformulário no Editor de comunicação interativa](/help/forms/interactive-communication/subform-component-in-interactive-communication-editor.md)
         + [Componente de Retângulo no Editor de comunicação interativa](/help/forms/interactive-communication/rectangle-component-in-interactive-communication-editor.md)
         + [Componente de tabela no Editor de comunicação interativa](/help/forms/interactive-communication/table-component-in-interactive-communication-editor.md)
         + [Componente de linha no editor de comunicações interativas](/help/forms/interactive-communication/line-component-in-interactive-communication-editor.md)
         + [Componente de código de barras no Editor de comunicação interativa](/help/forms/interactive-communication/barcode-component-in-interactive-communication-editor.md)
      ...
      + [Bloqueio de modelo no Editor de comunicações interativas](/help/forms/interactive-communication/template-lock-in-interactive-communication-editor.md)
      + [Numeração dinâmica de páginas no Editor de comunicação interativa](/help/forms/interactive-communication/dynamic-page-numbering-in-interactive-communicatio-editor.md)
      + [Manuseio de estouro de conteúdo no Editor de comunicação interativa](/help/forms/interactive-communication/content-overflow-handling-in-interactive-communication-editor.md)
      + [Suporte à edição de XDP no Editor de comunicação interativa](/help/forms/interactive-communication/support-xdp-editing-in-interactive-communication-editor.md)
