...
+ Notas de versão {#release-notes}
   ...
   + Notas de versão do recurso AEMaaCS {#release-notes}
      ...
      + 2026 {#2026}
         + [Notas da versão 2026.3.0](/help/release-notes/release-notes-cloud/2026/2026-3-0.md)
         + [Notas da versão 2026.2.0](/help/release-notes/release-notes-cloud/2026/2026-2-0.md)
         + [Notas da versão 2026.1.0](/help/release-notes/release-notes-cloud/2026/2026-1-0.md)
      + 2025 {#2025}
         + [Notas de versão para 2025.12.0](/help/release-notes/release-notes-cloud/2025/release-notes-2025-12-0.md)
   ...
   + Notas de versão de manutenção do AEMaaCS {#maintenance}
      ...
      + 2026 {#2026}
         + [Notas de versão de manutenção para 2026.4.0](/help/release-notes/maintenance/2026/2026-4-0.md)
         + [Notas de versão de manutenção para 2026.3.0](/help/release-notes/maintenance/2026/2026-3-0.md)
         + [Notas de versão de manutenção para 2026.2.0](/help/release-notes/maintenance/2026/2026-2-0.md)
         + [Notas de versão de manutenção para 2026.1.0](/help/release-notes/maintenance/2026/2026-1-0.md)
      + 2025 {#2025}
         + [Notas da versão de manutenção 2025.12.0](/help/release-notes/maintenance/2025/2025-12-0.md)
      ...
      + 2023 {#2023}
         ...
         + [Notas de versão de manutenção para 2023.10.0](/help/release-notes/maintenance/2023/2023-10-0.md)
   ...
   + Notas de versão do Universal Editor {#universal-editor}
      ...
      + 2026 {#2026}
         + [Notas de versão 2026.04.30](/help/release-notes/universal-editor/2026/2026-04-30.md)
         + [Notas de versão 2026.04.09](/help/release-notes/universal-editor/2026/2026-04-09.md)
         + [Notas de versão 2026.04.02](/help/release-notes/universal-editor/2026/2026-04-02.md)
         + [Notas de versão 2026.03.26](/help/release-notes/universal-editor/2026/2026-03-26.md)
         + [Notas de versão 2026.03.19](/help/release-notes/universal-editor/2026/2026-03-19.md)
         + [Notas de versão 2026.03.12](/help/release-notes/universal-editor/2026/2026-03-12.md)
         + [Notas de versão 2026.03.05](/help/release-notes/universal-editor/2026/2026-03-05.md)
         + [Notas de versão 2026.02.26](/help/release-notes/universal-editor/2026/2026-02-26.md)
         + [Notas de versão 2026.02.19](/help/release-notes/universal-editor/2026/2026-02-19.md)
         + [Notas de versão 2026.02.13](/help/release-notes/universal-editor/2026/2026-02-13.md)
         + [Notas de versão 2026.02.05](/help/release-notes/universal-editor/2026/2026-02-05.md)
         + [Notas de versão 2026.01.29](/help/release-notes/universal-editor/2026/2026-01-29.md)
         + [Notas de versão 2026.01.22](/help/release-notes/universal-editor/2026/2026-01-22.md)
         + [Notas de versão 2026.01.15](/help/release-notes/universal-editor/2026/2026-01-15.md)
      + 2025 {#2025}
         + [Notas de versão 2025.12.12](/help/release-notes/universal-editor/2025/2025-12-12.md)
...
+ Segurança {#security}
   ...
   + [Teste de Conectividade de Rede](/help/security/network-connectivity-test.md)
   ...
   + [Migração para Identidade Externa e Associação de Grupo Dinâmico](/help/security/migrating-to-external-identity.md)
...
+ Sites {#sites}
   ...
   + Administração {#administering}
      + Fragmentos de conteúdo {#content-fragments}
         ...
         + [Reutilizar fragmentos de conteúdo usando o MSM](/help/sites-cloud/administering/content-fragments/msm-for-content-fragments.md)
      ...
      + Reutilizar conteúdo {#reusing-content}
         ...
         + Tradução {#translation}
            ...
            + [Configuração da integração de tradução de IA](/help/sites-cloud/administering/translation/ai-translation-integration.md)
   ...
   + Integração com o AEM as a Cloud Service {#integrations}
      ...
      + [Uso de fragmentos de conteúdo no Adobe Journey Optimizer](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/content-fragments-with-journey-optimizer.html?lang=pt-BR)
...
+ Ativos {#assets}
   ...
   + Compartilhar e distribuir ativos {#brand-portal}
      ...
      + [Publicar ativos de [!DNL Brand Portal] a [!DNL Assets]](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html?lang=pt-BR)

   + Assessor de conteúdo {#content-advisor}
      + [Supervisor de conteúdo para acessar conteúdo AEM em aplicativos Adobe e não Adobe](/help/assets/integrate-adobe-non-adobe-applications.md)
      ...
      + [Integração do Dynamic Media com recursos OpenAPI](/help/assets/integrate-dynamic-media-open-api.md)
   + Fragmentos de conteúdo {#content-fragments}
   ...
   + Dynamic Media {#dynamicmedia}
      ...
      + [Novo visualizador de vídeo](/help/assets/dynamic-media/new-video-viewer.md)
      ...
      + Dynamic Media com recursos OpenAPI {#dynamic-media-open-apis}
         ...
         + [Gerenciamento de cache](/help/assets/cache-management-dynamic-media-open-api.md)
   + Trabalho com a visualização do Assets {#assets-view}
      ...
      + [Exibição do Assets de metadados em cascata](/help/assets/cascading-metadata-assets-view.md)
...
+ Forms {#forms}
   ...
   + Integrar {#integrate}
      ...
      + Modelo de dados de formulário {#use-form-data-model}
         ...
         + [Conectar o formulário adaptável ao banco de dados Azure SQL](/help/forms/connect-adaptive-form-to-azure-sql.md)
      ...
      + Definir a Ação de envio para um Formulário adaptável {#set-submit-action}
         ...
         + Conectar um formulário adaptável ao Microsoft® SharePoint{#connect-to-sharepoint}
            + [Conectar um formulário adaptável ao Microsoft® SharePoint](/help/forms/configure-submit-action-sharepoint.md)
         ...
         + [Enviar um formulário adaptável para o Azure Blob Storage](/help/forms/configure-submit-action-azure-blob-storage.md)
         ...
         + [Enviar um formulário adaptável ao Microsoft® OneDrive](/help/forms/configure-submit-action-onedrive.md)
   ...
   + Formulários adaptáveis {#adaptive-forms-authoring}
      ...
      + [Gerenciar versões do Formulário Assets no Forms Manager](/help/forms/manage-form-versions-forms-manager.md)
      + Componentes principais {#authoring-adaptive-forms-core-components}
         + Criação de um Formulário adaptável {#create-an-adaptive-form-on-forms-cs}
            ...
            + [Personalização de temas do formulário adaptável usando o Editor de temas](/help/forms/customizing-themes-using-theme-editor.md)
            ...
            + [Gerar PDF de envio (antigo Documento de registro) para o Adaptive Forms](/help/forms/generate-document-of-record-core-components.md)
            + [Personalizar o modelo de documento de registro gerado automaticamente](/help/forms/customize-document-of-record-template.md)
            + [Tags de marcação do HTML compatíveis no Submission PDF](/help/forms/html-markup-tags-support-in-document-of-record.md)
      ...
      + Componentes de fundação {#authoring-adaptive-forms-foundation-components}
         + Converter seu PDF forms em Forms adaptável {#afcs}
            ...
            + [Converter um Formulário do PDF existente em um Formulário adaptável](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=pt-BR)
         ...
         + Adicionar componentes a um formulário adaptável {#add-components-to-an-adaptive-form}
            ...
            + [Usar componentes principais](https://experienceleague.adobe.com/pt-br/docs/experience-manager-core-components/using/introduction)
         ...
         + [Gerar PDF de envio (antigo Documento de registro)](/help/forms/generate-document-of-record-for-non-xfa-based-adaptive-forms.md)
...
+ Comunicação interativa {#interactive-communication}
   ...
   + Como {#howto}
      ...
      + [Criar versões e adicionar comentários](/help/forms/interactive-communication/versioning-and-commenting-in-interactive-communication-editor.md)
      + [Copiar e colar a comunicação interativa](/help/forms/interactive-communication/copy-and-paste-interactive-communication.md)
      + [Iniciar fluxo de trabalho na comunicação interativa](/help/forms/interactive-communication/start-workflow-in-interactive-communication-editor.md)
      + [Criar tabela dinâmica](/help/forms/interactive-communication/dynamic-table-in-interactive-communication-editor.md)
...
+ APIs de comunicações {#using-communications}
   ...
   + [APIs de comunicações do AEM Forms](/help/forms/aem-forms-communication-api-overview.md)
   ...
   + [APIs de comunicações do Forms - Tutorial](/help/forms/aem-forms-cloud-service-communications-on-demand-processing.md)
   + [Gerar saída AFP usando a API do AEM Forms](/help/forms/document-generation-afp-api.md)
   + [Autenticação de servidor para servidor OAuth](/help/forms/oauth-api-authetication.md)
   + [Autenticação de servidor para servidor JWT(JSON Web Token)](/help/forms/jwt-api-authentication.md)
   ...
   + Referência da API do desenvolvedor {#aem-forms-developer-api-reference}
      + [Referência da API do Forms adaptável](https://developer-stage.adobe.com/experience-cloud/experience-manager-apis/api/stable/forms/)
...
+ IA no AEM {#ai-in-aem}
   ...
   + Suporte a MCP {#mcp-support}
      + [Uso do MCP com o AEM as a Cloud Service](/help/ai-in-aem/mcp-support/using-mcp-with-aem-as-a-cloud-service.md)
      + Aplicativos de bate-papo (Web e desktop) {#chat-applications}
         + [Configuração de Claude Antrópico com AEM MCP](/help/ai-in-aem/mcp-support/setup-claude.md)
         + [Configuração do OpenAI ChatGPT com o AEM MCP](/help/ai-in-aem/mcp-support/setup-chatgpt.md)
      + Ferramentas do desenvolvedor (extensões do IDE, aplicativos da área de trabalho, CLIs) {#developer-tools}
         + [Configurando o Cursor com o AEM MCP](/help/ai-in-aem/mcp-support/setup-cursor.md)
      + Plataformas empresariais {#enterprise-platforms}
         + [Configuração do Microsoft Copilot Studio com AEM MCP](/help/ai-in-aem/mcp-support/setup-microsoft-copilot-studio.md)
         + [Configuração do JetBrains com o Copilot do GitHub e o MCP do AEM](/help/ai-in-aem/mcp-support/setup-jetbrains-copilot.md)
   + [Desenvolvimento local com ferramentas de IA](/help/ai-in-aem/local-development-with-ai-tools.md)
   + Agentes no AEM {#agents}
      + [Visão geral](/help/ai-in-aem/agents/overview.md)
      + Brand Experience Agent {#brand-experience}
         + [Visão geral](/help/ai-in-aem/agents/brand-experience/overview.md)
         + Agente de produção de experiência {#experience-production}
            + [Visão geral](/help/ai-in-aem/agents/brand-experience/experience-production/overview.md)
            + [Tarefa de atualização de conteúdo](/help/ai-in-aem/agents/brand-experience/experience-production/content-update.md)
            + [Trabalho de Criação de Comunicação](/help/ai-in-aem/agents/brand-experience/experience-production/communication-creation.md)
            + [Trabalho de Criação de Formulário](/help/ai-in-aem/agents/brand-experience/experience-production/form-creation.md)
         + Agente de modernização de experiência {#modernization}
            + [Visão geral](/help/ai-in-aem/agents/brand-experience/modernization/overview.md)
            + [Introdução](/help/ai-in-aem/agents/brand-experience/modernization/getting-started.md)
            + [Introdução aos projetos de criação do AEM](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md)
            + [Console de Modernização](/help/ai-in-aem/agents/brand-experience/modernization/console.md)
            + [Guia de solicitação](/help/ai-in-aem/agents/brand-experience/modernization/prompting-guide.md)
            + [Habilidade de documentação do projeto](/help/ai-in-aem/agents/brand-experience/modernization/project-documentation.md)
            + [Entrega da AOE](/help/ai-in-aem/agents/brand-experience/modernization/aoe-delivery.md)
         + [Agente de desenvolvimento](/help/ai-in-aem/agents/brand-experience/development/development.md)
      + Agente do Supervisor de Conteúdo {#content-advisor}
         + [Visão geral](/help/ai-in-aem/agents/content-advisor/overview.md)
         + [Agente de Descoberta de Conteúdo](/help/ai-in-aem/agents/content-advisor/discovery.md)
         + [Agente de otimização de conteúdo](/help/ai-in-aem/agents/content-advisor/content-optimization.md)
      + Agente de governança de marca {#governance}
         + [Visão geral](/help/ai-in-aem/agents/governance/overview.md)
         + [Como importar uma política de marca](/help/ai-in-aem/agents/governance/how-to-import-a-brand-policy.md)
...
+ Headless {#headless}
   ...
   + Fragmentos de conteúdo {#content-fragments}
      ...
      + Criação{#authoring}
         ...
         + [Editor de Markdown](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/markdown.html?lang=pt-BR)
      + [Visualização de fragmentos](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/preview.html?lang=pt-BR)
   ...
   + Seletor de fragmentos de conteúdo {#content-fragment-selector}
      ...
      + [Integrar a um aplicativo do Adobe](/help/headless/content-fragment-selector/integrate-adobe-application.md)
      + [Integrar a aplicativos que não sejam da Adobe ou de terceiros](/help/headless/content-fragment-selector/integrate-non-adobe-application.md)
      + [Integrar seletor de fragmento de conteúdo usando o Vanilla JS](/help/headless/content-fragment-selector/integrate-using-vanilla-js.md)
...
+ Implementação {#implementing}
   ...
   + Usar o Cloud Manager {#using-cloud-manager}
      ...
      + Gerenciar o código {#managing-code}
         ...
         + [Adicionar um repositório externo](/help/implementing/cloud-manager/managing-code/external-repositories.md)
         + [Gerenciar tokens de acesso de repositórios externos](/help/implementing/cloud-manager/managing-code/manage-access-tokens.md)
   ...
   + Desenvolvimento do AEM as a Cloud Service {#developing}
      ...
      + [Funções do AEM Edge](/help/implementing/developing/introduction/edge-functions.md)
      ...
      + Editor universal {#universal-editor}
         ...
         + [Configuração do seletor de Assets](/help/implementing/universal-editor/configure-assets-selector.md)
      ...
      + Desenvolvimento híbrido e SPA {#hybrid}
         ...
         + [Habilitação de exportação em JSON para um componente](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/full-stack/components-templates/enabling-json-exporter.html?lang=pt-BR)
   ...
   + Ferramentas do desenvolvedor {#developer-tools}
      ...
      + [Console da Web](/help/implementing/developing/tools/web-console.md)
   ...
   + Personalização {#personalization}
      ...
      + [Configuração da segmentação com o ContextHub](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/personalization/contexthub-segmentation.html?lang=pt-BR)
   ...
   + Visão geral da entrega de conteúdo {#content-delivery}
      ...
      + [Trechos de configuração da CDN para cenários comuns](/help/implementing/dispatcher/cdn-configuration-snippets-common-scenarios.md)
...
+ Conformidade {#compliance}
   ...
   + HIPAA {#hipaa}
      + [Disponibilidade para HIPAA](/help/compliance/hipaa/hipaa-readiness.md)
