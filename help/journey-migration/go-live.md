...
>title="Preparação para ativação"
>abstract="Para garantir um início tranquilo e bem-sucedido do AEM as a Cloud Service, você deve planejar períodos de congelamento de código e conteúdo, iterações de teste, atualizações complementares de conteúdo, testes de desempenho, testes de segurança e muito mais."
...
* Criar grupos de notificação do usuário Admin Console. Consulte [Grupos de usuários para notificações](/help/journey-onboarding/user-groups.md)
