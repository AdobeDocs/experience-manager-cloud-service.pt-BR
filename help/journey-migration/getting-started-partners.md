...
O Adobe Experience Manager (AEM) as a Cloud Service oferece uma base reformulada para o Experience Manager, com base em uma infraestrutura baseada em contêiner, desenvolvimento orientado por API e processo DevOps guiado, permitindo que profissionais de marketing e desenvolvedores sempre se mantenham à frente da curva das inovações de gerenciamento da experiência do cliente.
...
Os desenvolvedores gravam o código e o testam localmente, que é então enviado para ambientes remotos do AEM as a Cloud Service.
...
1. [Configurar Pipelines CM](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html)
...
3. [Noções Básicas Sobre Os Resultados De Teste](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/overview-test-results.html)
4. **Acessando Logs**
...
3. [CRXDE Lite](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/repository-browser.html) (disponível somente em ambientes SDK local e Experience Manager Cloud Dev)
4. [Logs e logs](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/logs.html#debugging)
   * [Logs CM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/build-and-deployment.html#debugging) (teste de unidade de compilação, verificação de código, imagem de compilação, implantação)
...
>1. [Contate a Equipe de Suporte do Experience Manager](https://experienceleague.adobe.com/docs/customer-one/using/home.html)
...
A jornada de transição para o Cloud Service envolve três fases - Planejamento, Execução e Ativação do Post.
...
Antes de iniciar a jornada de transição para Cloud Service, você deve se familiarizar com o as a Cloud Service de Experience Manager e rever as alterações notáveis que foram feitas nele, além de revisar os recursos que foram substituídos ou descontinuados.
...
2. Execute o código do cliente por meio do [Cloud Manager Quality Pipeline](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/using/code-quality-testing.html)
