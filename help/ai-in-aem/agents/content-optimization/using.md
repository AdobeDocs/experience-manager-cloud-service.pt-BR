...
* **[Colaboração perfeita com o Discovery Agent](/help/ai-in-aem/agents/discovery/using.md)**: baseia-se nos ativos identificados pelo Discovery Agent, permitindo recuperação e otimização completas de ativos por meio de conversação natural.
...
Você pode acessar os AEM Business Agents por meio do Assistente de IA. Faça logon em experience.adobe.com e você pode começar a interagir com o Assistente de IA especificando seu prompt em linguagem natural usando o campo `Ask AI Assistant anything`:
...
* **Criação de representação de alta resolução**
  ...
  Pesquise o ativo correto usando o [Agente de descoberta](/help/ai-in-aem/agents/discovery/using.md) e use os seguintes prompts no caso de vários resultados de pesquisa:
