...
A configuração do MCP para AEM envolve três partes principais:

1. **Uma configuração única no AEM por um administrador**, permitindo que aplicativos clientes MCP específicos acessem os servidores MCP da AEM
