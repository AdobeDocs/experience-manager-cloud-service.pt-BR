...
![A caixa de diálogo Configurações do Claude.](assets/claude-1.png)

![O painel Conectores em Claude.](assets/claude-2.png)

![Adicionando um conector personalizado em Claude.](assets/claude-3.png)

![Conectando o conector personalizado no Claude.](assets/claude-4.png)

![O formulário de configuração de conector personalizado em Claude.](assets/claude-5.png)

![A caixa de diálogo de permissões da ferramenta para o conector personalizado.](assets/claude-6.png)

![Solicitando que Claude use o Serviço AEM Content MCP.](assets/claude-7.png)
