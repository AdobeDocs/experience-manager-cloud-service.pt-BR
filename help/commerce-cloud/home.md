...
Esta página lista os recursos de autoajuda relacionados ao Comércio AEM como um Cloud Service.

## Principais artigos de comércio {#key-articles}

* [Introdução do comércio AEM como Cloud Service](overview.md)
* [Arquitetura do comércio AEM como Cloud Service](architecture/magento.md)
