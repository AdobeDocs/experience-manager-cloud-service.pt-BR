...
Para garantir que as alterações de instalação, código e configuração do pacote acima estejam corretas, recrie e implante o projeto do AEM Commerce atualizado usando o seguinte comando Maven: `$ mvn clean install -PautoInstallSinglePackage`.
...
1. Criar e implantar o projeto do AEM Commerce atualizado
