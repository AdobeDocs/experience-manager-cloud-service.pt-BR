...
Saiba como trabalhar com o Cockpit de produtos, que fornece uma visão geral unificada de catálogos de produtos vinculados e conteúdo associado.
...
Os catálogos de produtos devem ser configurados no AEM. Consulte [configurando armazenamento e catálogos](/help/commerce-cloud/cif-storefront/getting-started.md#catalog) para obter mais informações.

A habilitação de recursos de catálogo em etapas requer autenticação. Consulte [Introdução](/help/commerce-cloud/cif-storefront/getting-started.md) para obter mais informações.
