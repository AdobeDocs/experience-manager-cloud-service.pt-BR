...
| `cacheNames` | Esses valores são definidos na fábrica correspondente de configuração de cliente do CIF GraphQL >> Configuração de GraphQL do StorePath correspondente >> Configurações de cache do GraphQL | Matriz | Não | |
