...
**Novo no AEM as a Cloud Service?** Confira [um guia mais detalhado para configurar um ambiente de desenvolvimento local usando o AEM as a Cloud Service SDK](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/local-development-environment-set-up/overview.html).
