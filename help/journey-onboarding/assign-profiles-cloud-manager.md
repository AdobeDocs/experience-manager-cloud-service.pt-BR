...
1. Identifique os usuários que precisam gerenciar os programas do Cloud Manager. Estes são os seus **Proprietários de empresas**.

1. Faça logon no Admin Console em `[adminconsole.adobe.com](https://adminconsole.adobe.com/enterprise/overview)` e na página **Visão Geral**, selecione o produto da **Adobe Experience Manager as a Cloud Service** no cartão **Produtos e Serviços**.
...
É recomendável continuar a jornada de integração conforme descrito anteriormente. Estes são alguns recursos adicionais se você quiser se aprofundar em um tópico específico desta jornada.
...
* [Tipos de identidade no Adobe Admin Console](https://helpx.adobe.com/br/enterprise/admin-guide.html/enterprise/using/identity.ug.html) - O sistema Identity Management da Adobe ajuda os administradores a criar e gerenciar o acesso do usuário a aplicativos e serviços. A Adobe oferece esses tipos de identidades ou contas para autenticar e autorizar os usuários.
