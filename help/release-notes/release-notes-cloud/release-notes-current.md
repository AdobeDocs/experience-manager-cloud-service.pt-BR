...
Declarar [redirecionamentos do navegador](/help/implementing/dispatcher/cdn-configuring-traffic.md#client-side-redirectors) em um arquivo de configuração Git que são implantados e avaliados no CDN. Isso pode ser útil para cenários como exclusão de páginas, alteração da estrutura do site e otimização de SEO.
