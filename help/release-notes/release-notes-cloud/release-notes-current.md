...
As APIs obsoletas que direcionam a remoção de 30/02/2026 não devem mais ser usadas no código. Para evitar bloqueios de implantação, remova o uso da API antes de 30 de março de 2026. Datas importantes:
