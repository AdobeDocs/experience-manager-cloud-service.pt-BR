---
title: Notas de versão do  [!DNL Adobe Experience Manager] as a Cloud Service 2026.2.0.
description: Notas de versão do  [!DNL Adobe Experience Manager] as a Cloud Service 2026.2.0.
...
# Notas de versão 2026.2.0 para [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

A seção a seguir descreve as notas de versão de recursos da versão 2026.2.0 do as a Cloud Service [!DNL Experience Manager].
...
A data de lançamento da versão atual (2026.2.0) do [!DNL Adobe Experience Manager] as a [!DNL Cloud Service] é 3 de março de 2026. A próxima versão do recurso (2026.3.0) está planejada para 26 de março de 2026.
...
Assista ao vídeo Visão geral da versão de fevereiro de 2026 que exibe um resumo dos recursos adicionados na versão 2026.2.0:
