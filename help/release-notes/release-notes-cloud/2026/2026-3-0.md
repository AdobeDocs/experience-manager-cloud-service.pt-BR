---
title: Notas de versão do  [!DNL Adobe Experience Manager] as a Cloud Service 2026.3.0.
description: Notas de versão do  [!DNL Adobe Experience Manager] as a Cloud Service 2026.3.0.
...
# Notas de versão 2026.3.0 para [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

A seção a seguir descreve as notas de versão de recursos da versão 2026.3.0 do as a Cloud Service [!DNL Experience Manager].
...
A data de lançamento da versão atual (2026.3.0) do [!DNL Adobe Experience Manager] as a [!DNL Cloud Service] é 26 de março de 2026. A próxima versão do recurso (2026.4.0) está planejada para 30 de abril de 2026.
