...
### Propriedades OSGi não modificáveis {#unmodifiable-osgi-properties}

As propriedades para os seguintes PIDs de componente OSGi não podem ser modificadas, conforme descrito abaixo.
...
No futuro, o Adobe aplicará as seguintes restrições de propriedades OSGi; portanto, o uso deve ser interrompido.
