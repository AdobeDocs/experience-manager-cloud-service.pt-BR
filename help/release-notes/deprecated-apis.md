...
<tbody>
  ...
  <tr>
    ...
    <td>O AEM as a Cloud Service não é compatível com modos de execução ou acesso ao sistema de arquivos no momento de execução. </td>
    <td>10/5/20</td>
    <td>Final de 2021</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>org.slf4j.spi</td>
    <td>Esta API interna do log4j não é suportada por AEM as a Cloud Service.</td>
    <td>27/1/2022</td>
    <td>24/3/2022</td>
  </tr>
</tbody>
