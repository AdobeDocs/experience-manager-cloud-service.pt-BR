...
## Versão 17882 {#release-17882}

Veja abaixo um resumo das melhorias contínuas da versão de manutenção 17882, lançada publicamente em quarta-feira, 24 de setembro de 2024. A versão de manutenção anterior era a versão 17689.
...
### Aprimoramentos {#enhancements-17882}
...
### Problemas corrigidos {#fixed-issues-17882}
...
* SITES - 2864: Acessibilidade - o recurso Arrastar e soltar não é acessível pelo teclado.

### Problemas conhecidos {#known-issues-17882}
...
### Recursos e APIs obsoletos {#deprecated-17882}
...
### Correções de segurança {#security-17882}
...
### Tecnologias integradas {#embedded-tech-17882}
