...
* SITES-19614: [Xwalk] Paginação de planilha/rolagem infinita.
...
* SITES-20405: [Xwalk] Suporte mimeType para recolhimento de campo.
...
* SITES-20666: o experimento [Xwalk] deve ser desativado por padrão na criação.
...
* SITES-20364: 302 redirecionamentos não funcionam com o seletor no URL.
* SITES-20547: lista de caminhos excluídos da Live Copy truncados no AEM as a Cloud Service.
* SITES-20401: [Xwalk] Os metadados de seção não dão suporte a propriedades de vários valores.
* SITES-20496: [Xwalk] Nenhuma opção de propriedades ao selecionar planilha no administrador do site.
...
* ASSETS-32321: a resolução do fluxo de trabalho de processamento do Post falha se a pasta ancestral estiver sem o subnó &quot;jcr:content&quot;.
...
* ASSETS-35226: fluxo de trabalho de processamento Post não resolvido se especificado na raiz DAM.
