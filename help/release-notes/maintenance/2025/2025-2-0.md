...
>[!NOTE]
>
>A versão 19586 tornou-se privada em 26 de fevereiro e foi substituída pela versão 19687.
...
* GRANITE-56650: a distribuição de conteúdo deve sinalizar apenas a fila bloqueada após algumas tentativas.
* SKYOPS-89616: permite criar até 40 contas técnicas no Adobe Developer Console.

### Problemas corrigidos {#fixed-issues-19567}

* CNTBF-232: pacotes profundos nt:file para incluir nós jcr:content secundários obrigatórios.
