---
title: Notas de versão de manutenção do  [!DNL Adobe Experience Manager] as a Cloud Service associado à ativação de recurso do 2026.4.0.
description: Notas de versão de manutenção do  [!DNL Adobe Experience Manager] as a Cloud Service associado à ativação de recurso do 2026.4.0.
...
A seção a seguir descreve as notas de versão técnicas da versão de manutenção do Experience Manager as a Cloud Service associada à ativação de recursos do 2026.4.0.
...
Resumidos abaixo estão as melhorias contínuas da versão de manutenção 25194, que foi lançada publicamente em 1 de abril de 2026. A versão de manutenção anterior era 24678.
