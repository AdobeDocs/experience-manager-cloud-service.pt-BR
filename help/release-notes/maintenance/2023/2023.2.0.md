...
Resumidos abaixo estão as melhorias contínuas da versão de manutenção 11873, que foi lançada publicamente em 3 de maio de 2023. Esta versão de manutenção é uma atualização da versão de manutenção anterior: 11835.
...
- SITES-1200 - Pesquise melhorias na API com filtragem baseada em tags
- GRANITE-42939 - Adicione anotações e avisos de desativação ao código oauth-server

### Problemas conhecidos {#known-issues-11873}

- SITES-13253 - RecursionTooDeepException nos componentes principais v2.22.6
- SITES-13256 - Teaser do WCM principal configurado com renderização de página de quebras de URL especial
...
- SKYSI-19884/SKYOPS-53745 - Correção de problema com PublishPageRenderingErrorsHigh
- GRANITE-4388 - Corrigida a degradação da taxa de transferência após um grande número de gravações de ativos DAM no Mongo
- SITES-11922 - Corrigido o problema com o cancelamento da publicação da visualização que não removia o status de sincronização
- ASSETS-21648 - Problema de permissão corrigido com a funcionalidade relacionada a ativos
...
- SITES-7796 - Capacidade do autor de conteúdo de publicar o fragmento de conteúdo, com suas respectivas variações, ao exportar para o Target
