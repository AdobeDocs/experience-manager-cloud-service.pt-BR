...
- SITES-12573 - Consultas GraphQL que usam variáveis dentro de um filtro falham se uma variável não for especificada. Não atualizar para esta versão você deverá usar o GraphQL com AEM as a Cloud Service.
