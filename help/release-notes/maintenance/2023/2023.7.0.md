...
- FORMS-9026: Quando um usuário cria um Formulário adaptável com base em um esquema JSON complexo e válido, arrasta os campos de esquema JSON relacionados para o Adaptive Forms Editor para criar campos do Adaptive Forms e atualiza a janela Adaptive Forms Editor, todos os campos são excluídos e o Adaptive Forms editor aparece em branco.
