...
1. Baixe o Designer da [Distribuição de Software](https://experience.adobe.com/downloads).
1. Clique duas vezes em setup.exe para executar o instalador.
1. Continue e forneça seus detalhes na tela do Personalization.
1. Se você aceitar o contrato de licença, clique em **[!UICONTROL Avançar]** para continuar.
1. (Opcional) altere o caminho de instalação padrão para instalar o Designer no local de sua escolha. Clique em **[!UICONTROL Avançar]**.
1. Clique em **[!UICONTROL Voltar]** para alterar as preferências. Para instalar o Designer, clique em **[!UICONTROL Instalar]**.
