...
description: Saiba como integrar o Salesforce ao AEM Forms usando o fluxo de credenciais do cliente OAuth 2.0. Ele exibe etapas para a integração do AEM Forms Salesforce.
...
![Fluxo de trabalho ao definir a comunicação entre o AEM Forms e o aplicativo do Salesforce](/help/forms/assets/salesforce-workflow.png)
