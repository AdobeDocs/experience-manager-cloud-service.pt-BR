...
Você pode usar o **Conector de armazenamento unificado** para se conectar ao Armazenamento de blobs e o **Modelo de dados de formulário (FDM)** para se conectar a bancos de dados ou serviços de back-end (RESTful, SOAP, Armazenamento de blobs da Azure e muito mais).
