...
* Para uma configuração em lote, somente uma instância de combinação de valores de OutputType(PDF, PRINT) e RenderType(PostScript, PCL, IPL, ZPL e assim por diante) é permitida.
