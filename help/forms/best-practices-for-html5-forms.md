...
* Habilitar compactação da Web. Reduz o tamanho das solicitações e respostas originadas de um formulário. <!-- For details, see [Performance tuning of AEM Forms Server](https://helpx.adobe.com/br/aem-forms/6-3/performance-tuning-aem-forms.html)-->
