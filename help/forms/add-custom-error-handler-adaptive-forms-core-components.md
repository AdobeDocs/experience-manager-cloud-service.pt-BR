...
1. Clique em **[!UICONTROL Adicionar manipulador de sucesso]**. O editor de regras **[!UICONTROL Manipulador de Êxito de Chamar Serviço]** é aberto.
1. Na seção **[!UICONTROL Then]**, adicione uma regra para definir o valor de **[!UICONTROL Pet Name]** como **`name`** usando os dados eventpayload.
1. Clique em **[!UICONTROL Concluído]** para fechar o editor **[!UICONTROL Chamar Manipulador de Êxito do Serviço]**.
1. Clique em **[!UICONTROL Adicionar Manipulador de Falha]**. O editor de regras **[!UICONTROL Chamar Manipulador de Falha de Serviço]** é aberto.
1. Na seção **[!UICONTROL Then]**, selecione **[!UICONTROL Function Output]** e escolha **[!UICONTROL Manipulador de Erros Padrão]**.
1. Clique em **[!UICONTROL Concluído]** para fechar o editor **[!UICONTROL Chamar Manipulador de Falha de Serviço]**.
...
1. Clique em **[!UICONTROL Concluído]** para fechar o editor **[!UICONTROL Chamar Manipulador de Êxito do Serviço]**.
1. Clique em **[!UICONTROL Adicionar Manipulador de Falha]**. O editor de regras **[!UICONTROL Chamar Manipulador de Falha de Serviço]** é aberto.
1. Na seção **[!UICONTROL Then]**, selecione **[!UICONTROL Function Output]** e escolha **[!UICONTROL Custom Error Handler Function]**.
1. Clique em **[!UICONTROL Concluído]** para fechar o editor **[!UICONTROL Chamar Manipulador de Falha de Serviço]**.
1. Clique em **[!UICONTROL Concluído]** para salvar a regra.
