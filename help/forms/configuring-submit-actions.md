...
# Enviar ação para o Forms adaptável com base nos componentes de base
...
O [Forms adaptável baseado no Componente de Fundação](/help/forms/creating-adaptive-form.md) oferece suporte a várias [ações de envio prontas para uso](#submit-actions-supported-by-adaptive-forms-based-on-foundation-components). Uma ação Enviar é acionada quando um usuário clica no botão **[!UICONTROL Enviar]** em um Formulário adaptável.

## Enviar ações para o Forms com base nos Componentes de base

As seguintes ações de envio são compatíveis com o Forms adaptável com base nos componentes de base:
...
Também é possível enviar um formulário adaptável com base nos componentes de base para outras configurações de armazenamento:
...
Além disso, você pode [personalizar as Ações de Envio padrão](/help/forms/custom-submit-action-form.md) para alinhar-se a requisitos organizacionais específicos.

### Configurar uma ação enviar para o formulário com base nos componentes de base
...
![Ação Enviar do AEM Forms](/help/forms/assets/submit-form-foundation-component.png)
