...
description: Saiba como instalar e configurar um ambiente do as a Cloud Service  [!DNL AEM Forms] .
...
# Integrar ao as a Cloud Service [!DNL AEM Forms] {#overview}
...
<!-- When you sign up for the service, Adobe creates an Organization identifier for your company in the Adobe Identity Management System (IMS), where your users and their permissions can be managed. So, --> Antes de integrar a um ambiente do Adobe Experience Manager (AEM) Forms as a Cloud Service, decida os perfis e estruture uma equipe para o seu projeto. Uma equipe típica de projeto [!DNL AEM Forms] tem as seguintes personalidades:
...
* **Profissional do Forms**: um profissional do Forms cria Forms adaptável, temas e modelos de acordo com o estilo, o layout e a marca fornecidos pelo Designer UX. O profissional também cria e integra o Formulário adaptável a um Modelo de dados de formulário (FDM) e Fluxos de trabalho do AEM. Um profissional da Forms normalmente executa tarefas relacionadas ao front-end.

* **Desenvolvedor do Forms**: um desenvolvedor do Forms desenvolve uma solução de formulários personalizada. Um desenvolvedor do Forms normalmente realiza o desenvolvimento de back-end, como desenvolver componentes personalizados, fluxos de trabalho do AEM, serviços de pré-preenchimento e muito mais.

* **Administrador do AEM**: um administrador do AEM ajuda com a configuração geral, como configurar usuários, fortalecer o ambiente, configurar fontes de dados, configurar email e software de terceiros. O administrador do AEM também ajuda nas integrações como a integração com o Adobe Analytics, o Adobe Target e o Adobe Sign.
...
* (Somente para sandboxes) Após a integração do serviço, [crie](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/using/pipelines/production-pipelines.html?lang=en) e [execute](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/using/code-deployment.html) os pipelines de produção e não produção. Ele habilita e traz os recursos mais recentes do [!DNL AEM Forms] as a Cloud Service para o seu ambiente.

Você pode usar o Forms as a Cloud Service para criar um formulário adaptável (Inscrição digital) ou gerar uma comunicação com o cliente. Após concluir a [Integração](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/onboarding/journey/overview.html?lang=pt-BR) com o as a Cloud Service [!DNL Adobe Experience Manager], execute as ações a seguir para habilitar os recursos Forms - Inscrição Digital ou Comunicação com o Cliente. <!--You can also enable both the features-->:
...
Após concluir a integração com o serviço, faça logon no ambiente do as a Cloud Service [!DNL AEM Forms], abra instâncias de Autor e Publicação e adicione usuários aos [grupos do AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/accessing/aem-users-groups-and-permissions.html#accessing) específicos do Forms, com base na persona. A tabela a seguir lista os grupos do AEM específicos do Forms, disponíveis imediatamente e os tipos de usuário correspondentes. A tabela também fornece o tipo de instância do AEM para cada tipo de usuário:
...
Para obter mais informações sobre grupos do AEM específicos do Forms e as permissões correspondentes, consulte [Grupos e permissões](forms-groups-privileges-tasks.md).
