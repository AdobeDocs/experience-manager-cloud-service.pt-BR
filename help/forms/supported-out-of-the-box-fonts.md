...
description: O AEM Forms as a Cloud Service oferece suporte a fontes prontas para uso para documentos de registro e PDFs.
...
* To generate Document of Record to archive AEM forms and content together in PDF format ([Click to know more](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/generate-document-of-record-for-non-xfa-based-adaptive-forms)).
-->
...
Além das fontes mencionadas acima, é possível usar fontes personalizadas para dar aos PDFs uma aparência específica. Para habilitar fontes personalizadas, você [adiciona fontes personalizadas ao seu ambiente Forms as a Cloud Service](/help/forms/use-custom-fonts.md) com uma licença válida.
