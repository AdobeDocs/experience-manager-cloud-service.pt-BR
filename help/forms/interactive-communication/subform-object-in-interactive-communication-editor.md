---
title: Objeto Subformulário no Editor de comunicação interativa
description: O Objeto de subformulário no Editor de comunicação interativa no AEM Forms permite organizar vários elementos de formulário de maneira flexível e estruturada.
...
# Objeto Subformulário no Editor de comunicação interativa
