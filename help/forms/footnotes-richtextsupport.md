...
## Comportamento do marcador de posição da nota de rodapé no Adaptive Forms
...
* As notas de rodapé oferecem suporte a quebras de linha, permitindo que os autores de formulários formatem conteúdo em várias linhas no componente **[!UICONTROL Espaço Reservado para Nota de Rodapé]**.
* As notas de rodapé permanecem sempre visíveis no **[!UICONTROL Espaço Reservado para Nota de Rodapé]**, independentemente da visibilidade dos painéis associados.
