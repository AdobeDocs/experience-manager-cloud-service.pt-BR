...
Verifique se os [Componentes principais do Forms adaptável estão habilitados para o ambiente as a Cloud Service do AEM Forms](enable-adaptive-forms-core-components.md).
