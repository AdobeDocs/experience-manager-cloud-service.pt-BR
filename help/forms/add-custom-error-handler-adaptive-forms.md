...
description: O AEM Forms fornece manipuladores de sucesso e erro prontos para uso para um formulário usando o endpoint REST configurado para chamar um serviço externo. Você pode adicionar um manipulador de erros padrão, bem como um manipulador de erros personalizado, em um Formulário adaptável do AEM.
...
* **`Response:`**
      ...
      &quot;dataRef&quot;: &quot;&quot;,
      &quot;details&quot;: [
      &quot;ID inválida fornecida. O valor fornecido não está correto!&quot;
      ]
      }
      ]}
      &quot;
  ...
  ![Uma expressão de um campo de formulário adaptável para exibir a resposta ao erro no manipulador de erros personalizado](/help/forms/assets/custom-error-handler-somexpression.png)
...
* **`Response:`**
  ...
  ![Referência de dados de um campo de formulário adaptável para exibir a resposta ao erro no manipulador de erros personalizado](/help/forms/assets/custom-errorhandler-dataref.png)
...
> * Um manipulador de erros padrão é fornecido por padrão para exibir mensagens de erro nos campos se a resposta do erro estiver no esquema padrão. O manipulador de erros padrão também pode chamar o manipulador de erros personalizado se a resposta do erro não estiver em conformidade com o esquema padrão.
...
1. Vá até `[AEM Forms as a Cloud Service repository folder]/apps/[AEM Project Folder]/clientlibs/`.
...
Vamos adicionar o seguinte código ao arquivo JavaScript para exibir a resposta e os cabeçalhos, recebidos do endpoint do serviço REST, no console do navegador.
       ...
       * @name customErrorHandler Função de Manipulador de Erros Personalizada
       * @errorHandler
       */
       função customErrorHandler(response, cabeçalhos)
       {
       console.log(&quot;Início do processamento do manipulador de erros personalizado...&quot;);
       console.log(&quot;response:&quot;+JSON.stringify(response));
       console.log(&quot;cabeçalhos:&quot;+JSON.stringify(cabeçalhos));
       console.log(&quot;Fim do processamento do manipulador de erros personalizado...&quot;);
       }
       &quot;
...
![adicionar manipulador de erros personalizado em um formulário para lidar com respostas de erros](/help/forms/assets/custom-error-handler.png)
...
![adicionar um manipulador de erros personalizado em um formulário para lidar com respostas de erros](/help/forms/assets/custom-error-handler-message.png)
