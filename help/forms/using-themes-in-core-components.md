...
>[!NOTE]
>
>Se o Adaptive Forms estiver incorporado nas páginas do AEM Sites, será possível usar um único tema para o site e os formulários, incorporando um tema Adaptive Forms ao tema do site. Consulte [Incorporar um tema Adaptive Forms em um tema AEM Sites](/help/forms/embed-adaptive-forms-theme-in-site-theme.md).
...
>[!NOTE]
>
>Esta etapa se aplica quando você implanta o tema como um pacote **independente** por meio do pipeline de front-end (por exemplo, um repositório de tema dedicado do Forms). Se você **incorporar** o tema do Forms ao seu tema do AEM Sites, não será necessário definir um nome ou versão de tema separado para o tema do formulário; o nome do tema do site é usado. Consulte [Incorporar um tema Adaptive Forms em um tema AEM Sites](/help/forms/embed-adaptive-forms-theme-in-site-theme.md).
...
* [Incorporar um tema Adaptive Forms em um tema AEM Sites](/help/forms/embed-adaptive-forms-theme-in-site-theme.md)
