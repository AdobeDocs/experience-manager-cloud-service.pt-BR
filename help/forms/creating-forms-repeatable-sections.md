...
1. No modo de edição, selecione um painel e toque em ![cmppr](assets/cmppr.png). Na barra lateral, em Propriedades, ative **[!UICONTROL Tornar o painel repetível]**. Especifique os valores para a **[!UICONTROL Máximo]** e **[!UICONTROL Mínimo]** campos.
...
O subformulário repetível é semelhante aos painéis repetíveis no Adaptive Forms. Em [!DNL AEM Forms] No Designer, execute as seguintes etapas para criar um subformulário repetitivo:
...
Você pode criar painéis repetíveis a partir de um Esquema XML e da propriedade minOccours &amp; maxOccurs de qualquer elemento de tipo complexo. Para obter informações detalhadas sobre o Esquema XML, consulte [Criar Forms adaptável usando o esquema XML como modelo de formulário](adaptive-form-xml-schema-form-model.md).
...
>[!NOTE]
>
>Para o layout não-acordeão, use os componentes do botão Formulário adaptável para adicionar e remover instâncias.
