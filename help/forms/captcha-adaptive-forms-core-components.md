...
1. Crie o Contêiner de configuração em seu ambiente as a Cloud Service do AEM Forms. Um Contêiner de configuração contém as Configurações de nuvem usadas para conectar o AEM a serviços externos. Para criar e configurar um Contêiner de configuração para conectar seu ambiente do AEM Forms com o serviço reCAPTCHA do Google:
   ...
   1. Selecione uma pasta existente ou crie uma pasta. É possível
      * Crie uma pasta e habilite a opção Configurações de nuvem para ela:
         ...
         1. Clique em **[!UICONTROL Criar]**
            ![Criar uma configuração na nuvem para conectar seu ambiente do AEM Forms com o serviço reCAPTCHA da Google](/help/forms/assets/create-configuration.png){width="50%"}
      * Habilite a opção Configurações de nuvem para uma pasta existente:
