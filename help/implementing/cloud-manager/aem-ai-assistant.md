...
## Como obter acesso ao Assistente de IA no AEM{#get-access}
...
### Iniciar ou redefinir um Assistente de IA na conversa do AEM
...
1. No Assistente de IA no AEM, clique no ícone ![Mais](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg).
...
O Assistente de IA no AEM inclui um recurso de descoberta para ajudar você a explorar os tópicos e categorias compatíveis.
...
### Fornecer feedback sobre o Assistente de IA no AEM

Sua entrada ajuda a melhorar o Assistente de IA no AEM para obter melhor desempenho e precisão.
...
| ![Ícone de sinalizador](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Flag_18_N.svg) | Clique em para relatar preocupações ou fornecer feedback detalhado sobre sua interação com o Assistente de IA no AEM. |
