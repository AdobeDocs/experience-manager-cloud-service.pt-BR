...
1. A caixa de diálogo **Editar Pipeline de Produção** ou **Editar Pipeline de Não Produção** é exibida, permitindo que você edite os mesmos detalhes inseridos ao criar o pipeline.
