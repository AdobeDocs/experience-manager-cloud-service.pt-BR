...
Depois que você [criar seu programa de produção,](creating-production-programs.md) a [assistente de criação de programa](using-the-wizard.md) O orienta o usuário por meio de seleções, dependendo do objetivo dele ao criar o programa.
