...
description: Saiba como escrever testes funcionais do Java&trade; para o AEM as a Cloud Service
...
As classes de teste devem ser testes JUnit normais. A infraestrutura de teste é projetada e configurada para ser compatível com as convenções usadas pela biblioteca de testes `aem-testing-clients`. Os desenvolvedores são incentivados a usar essa biblioteca e seguir suas práticas recomendadas.
...
>[!NOTE]
>
> Caso precise de mais recursos, crie um caso de Atendimento ao cliente e descreva seu caso de uso. A equipe do Adobe analisa sua solicitação e fornece a assistência apropriada.
...
No entanto, ao executá-los, é necessário definir várias propriedades do sistema esperadas pelo `aem-testing-clients` (e a biblioteca subjacente de Clientes de teste do Sling).

As propriedades do sistema são mostradas a seguir.

| Propriedade | Descrição | Exemplo |
|-------------------------------------|------------------------------------------------------------------|-------------------------|
| `sling.it.instances` | número de instâncias, para corresponder ao serviço de nuvem, deve ser definido como `2` | `2` |
