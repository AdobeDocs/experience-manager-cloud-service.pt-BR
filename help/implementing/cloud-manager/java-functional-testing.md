...
No entanto, ao executá-los, é necessário definir uma variedade de propriedades do sistema esperadas pelo `aem-testing-clients` (e a biblioteca subjacente de Clientes de teste do Sling).
