...
description: Saiba mais sobre o lançamento do Cloud Manager 2026.2.0 no Adobe Experience Manager as a Cloud Service.
...
# Notas de versão do Cloud Manager 2026.2.0 no Adobe Experience Manager as a Cloud Service {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

Saiba mais sobre o lançamento do Cloud Manager 2026.2.0 no AEM (Adobe Experience Manager) as a Cloud Service.
...
A data de lançamento do Cloud Manager 2026.2.0 no AEM as a Cloud Service é quinta-feira, 5 de fevereiro de 2026.

A próxima versão está planejada para sexta-feira, 5 de março de 2026.
...
Não há correções de erros significativas na versão de fevereiro de 2026 do Cloud Manager.
