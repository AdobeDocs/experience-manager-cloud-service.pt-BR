...
* O Cloud Manager agora valida as datas de expiração não apenas para o [certificado principal](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md), mas também para certificados intermediários.
