...
* O [Painel de Licenças](/help/implementing/cloud-manager/license-dashboard.md) agora pode ser acessado por meio de um ponto de entrada distinto na [navegação](/help/implementing/cloud-manager/navigation.md) à esquerda.
