...
Se você licenciou Edge Delivery Services como parte do Adobe Experience Manager Sites, [agora é possível integrar seu site com Edge Delivery Services diretamente no Cloud Manager](/help/implementing/cloud-manager/edge-delivery/introduction-to-edge-delivery-services.md) e ativar usando uma experiência guiada de autoatendimento.
