...
* [O ambiente de criação](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/build-environment-details.md) foi atualizado para Maven versão 3.9.4 e versões do JDK jdk-11.0.22 e jdk1.8.0_401.
