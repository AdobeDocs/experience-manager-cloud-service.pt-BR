...
* **Suporte adicionado para Azure DevOps (repositórios privados)**
  ...
  As atualizações de documentação incluem etapas de configuração para Traga seu próprio Git com o Azure DevOps e validação de solicitação de pull. Consulte [Adicionar repositórios externos no Cloud Manager](/help/implementing/cloud-manager/managing-code/external-repositories.md).
