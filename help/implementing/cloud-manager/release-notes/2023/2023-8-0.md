...
* Quando um certificado expirar, os nomes de domínio e as listas de permissões de IP associados ao certificado não serão mais removidos do CDN.
   ...
   * [A interface do Cloud Manager](/help/implementing/cloud-manager/managing-ssl-certifications/introduction.md) fornecerá avisos antecipados mais visíveis de que o certificado SSL está prestes a expirar.
