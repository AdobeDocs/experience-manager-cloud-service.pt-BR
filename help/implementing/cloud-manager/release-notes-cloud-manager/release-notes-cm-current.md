...
* Uma mensagem aprimorada foi direcionada para a interface do usuário quando a variável **Adicionar programa** está desativado devido a direitos insuficientes para o locatário.
