...
1. Na página de destino do Cloud Manager, toque ou clique no **Gerenciar acesso** botão
...
1. Toque ou clique no **Adicionar tudo** na parte superior do **Permissões disponíveis** para adicionar todas as permissões.
