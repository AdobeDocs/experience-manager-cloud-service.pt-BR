...
Eles usam JUnit para implementação, são executados com Maven e dependem dos [Clientes de teste de AEM](https://github.com/adobe/aem-testing-clients) oficiais. O conjunto de testes do produto é mantido como
...
Consulte [testes de produtos de código aberto](https://github.com/adobe/aem-test-samples/tree/aem-cloud/smoke) ou o módulo [it.tests do Arquétipo de Projetos AEM](https://github.com/adobe/aem-project-archetype/tree/develop/src/main/archetype/it.tests) para ver exemplos.
...
Consulte [testes de exemplo de código aberto](https://github.com/adobe/aem-test-samples/tree/aem-cloud/) ou o módulo [ui.tests do Arquétipo de Projetos AEM](/help/implementing/cloud-manager/ui-testing.md) para ver exemplos.
