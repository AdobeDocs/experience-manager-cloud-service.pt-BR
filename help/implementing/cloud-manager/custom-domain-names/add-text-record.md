...
| `test.example.com`<br>`www.example.com` | `_aemverification.www.example.com` | Copie o valor inteiro exibido na interface do usuário do Cloud Manager. Isso é específico para o domínio e o ambiente . `Ex:adobe-aem-verification=www.example.com/[program]/[env]/..` |
