...
>[!NOTE]
>
>O usuário deve ter a função de **Proprietário da empresa** ou **Gerente de implantação** para adicionar um nome de domínio personalizado no Cloud Manager e você deve usar o Fastly CDN.
...
Siga estas etapas para adicionar um nome de domínio personalizado na página **Configurações de domínio**. Essas etapas são baseadas no Fastly. Se você usar um CDN diferente, deverá configurar seu domínio com o CDN que você escolheu usar.
...
>[!TIP]
>
>Leia o artigo a seguir sobre a necessidade de [Adicionar um CNAME ou um Registro no próximo](/help/implementing/cloud-manager/custom-domain-names/configure-dns-settings.md) para evitar o esforço duplicado ao adicionar registros DNS ao seu domínio personalizado. A entrada TXT e o registro CNAME ou A podem ser definidos simultaneamente no servidor DNS regulador.
