...
Consulte o documento [Configuração do seu pipeline de CI-CD](/help/implementing/cloud-manager/configuring-pipelines/introduction-ci-cd-pipelines.md) para saber mais sobre os diferentes tipos de pipelines.
