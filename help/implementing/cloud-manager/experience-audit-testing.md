...
>[!INFO]
>
>A partir de 31 de agosto de 2023, a Auditoria de experiência fará a transição para mostrar resultados específicos da plataforma móvel. Observe que as métricas de desempenho móvel normalmente se registram abaixo do desktop, portanto, antecipe uma mudança no desempenho relatado após essa alteração.
