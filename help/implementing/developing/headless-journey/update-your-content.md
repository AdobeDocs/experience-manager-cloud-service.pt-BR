...
No documento anterior da jornada sem cabeçalho AEM, [How to Access Your Content via AEM Delivery APIs](access-your-content.md) você aprendeu a acessar o conteúdo sem periféricos no AEM via API e agora deve:

* Entenda o que é GraphQL e como AEM API GraphQL funciona.
* Entenda algumas consultas práticas de amostra.

Este artigo se baseia nesses fundamentos para que você entenda como atualizar o conteúdo headless existente no AEM via API.
...
* **Objetivo**: Saiba como usar a REST API para acessar e atualizar o conteúdo dos Fragmentos de conteúdo:
   ...
   * Examine o código de amostra para ver como as coisas funcionam na prática.
...
* Entenda como os Fragmentos de conteúdo são suportados na API.
* Experimente o código de amostra e saiba como a API funciona na prática.
