...
description: Saiba mais sobre as diretrizes para o desenvolvimento de AEM as a Cloud Service e sobre maneiras importantes em que ele difere do AEM em instalações e do AEM no AMS.
...
>title="Diretrizes de desenvolvimento do AEM as a Cloud Service"
>abstract="Saiba mais sobre as diretrizes para o desenvolvimento de AEM as a Cloud Service e sobre maneiras importantes em que ele difere do AEM em instalações e do AEM no AMS."
...
### Ferramentas de desenvolvimento as a Cloud Service para AEM {#aem-as-a-cloud-service-development-tools}
