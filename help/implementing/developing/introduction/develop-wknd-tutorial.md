...
A implementação do tutorial utiliza muitos recursos avançados do AEM. O site é implementado usando:
...
* [HTL](https://experienceleague.adobe.com/docs/experience-manager-htl/using/getting-started/getting-started.html?lang=pt-BR)
