...
1. **Os Modelos de Site do AEM** são usados para definir o conteúdo base do site e a estrutura e o estilo do site, e são selecionados por um administrador ao criar um site.
1. Um **Tema do Site do AEM** está incluído no modelo e contém o CSS, o JavaScript e os recursos estáticos que definem o estilo do site.
