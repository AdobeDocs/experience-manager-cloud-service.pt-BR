...
O App Builder (anteriormente conhecido como Project Firefly) está disponível para clientes e parceiros corporativos por meio de nossa Visualização do desenvolvedor desde meados de 2020. A disponibilidade geral (GA) do App Builder está agendada para dezembro de 2021. Agradecemos aos desenvolvedores que experimentem o Construtor de aplicativos por meio de nossa [Programa de avaliação](https://adobe.ly/appbuilder-trial).
...
Para o tipo de solicitação de suporte ao desenvolvedor, incentivamos os desenvolvedores a usarem o [fórum do Experience League](https://experienceleaguecommunities.adobe.com/t5/project-firefly/ct-p/project-firefly).
