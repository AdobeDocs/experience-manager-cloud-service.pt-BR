...
* Tarefas que podem exigir esforço adicional:
   ...
   * A criação/remoção de novos elementos não atualizará a estrutura de dados de fragmentos simples (com base no modelo de Fragmento **** simples).
