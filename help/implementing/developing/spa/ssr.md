...
Ao usar o SSR, o fluxo de trabalho [de interação de](introduction.md#workflow) componentes dos SPAs no AEM inclui uma fase na qual o conteúdo inicial do aplicativo é gerado no Adobe I/O Runtime.
