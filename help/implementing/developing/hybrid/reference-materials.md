...
## SPA referências da API do Javascript para módulos NMP {#api-references}
...
>[!TIP]
>
>Consulte o documento de Materiais de referência de API para obter todas as APIs relacionadas a AEM.
