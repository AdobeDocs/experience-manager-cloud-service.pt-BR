...
Observar como um SPA se comporta para o usuário final e inspecionar a página do SPA ajuda a entender melhor como um SPA funciona com o editor de SPA do AEM.
