...
Um editor local permite que o usuário edite o conteúdo diretamente no fluxo de conteúdo, sem a necessidade de abrir uma caixa de diálogo. Por exemplo, o padrão **Texto** e **Título** ambos os componentes têm um editor inp-place.
...
A configuração a seguir habilita a edição no local do componente e define `plaintext` conforme o tipo do editor:
