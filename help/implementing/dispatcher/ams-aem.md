---
title: Migração da configuração do Dispatcher do AMS para o AEM como um Cloud Service
description: 'Migração da configuração do Dispatcher do AMS para o AEM como um Cloud Service '
feature: Dispatcher
...
# Migração da configuração do Dispatcher do AMS para o AEM como um Cloud Service {#Dispatcher-in-the-cloud}
