...
Os detalhes da página atual publicam o delivery de conteúdo do serviço no AEM como um Cloud Service. O delivery de conteúdo do serviço de publicação inclui:
...
1. Se o conteúdo não estiver totalmente armazenado em cache, o dispatcher chamará (proxy reverso) para a publicação AEM
