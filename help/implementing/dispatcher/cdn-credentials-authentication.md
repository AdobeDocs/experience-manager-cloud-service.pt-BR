...
Os clientes podem limpar o cache do CDN usando um token de API de limpeza declarado. O token é declarado com a sintaxe abaixo.  Consulte a [Configuração comum](#common-setup) para saber como implantá-la.
