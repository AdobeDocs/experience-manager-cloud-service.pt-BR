...
<table>
  ...
  <tr>
   ...
   <tr>
    <td>Suporte para ES2022 </td>
    <td>O ES2022 ainda não é suportado; o suporte está limitado aos recursos do ES5 JavaScript. </td>
    <td>O suporte para recursos modernos do JavaScript, por exemplo, funções de seta e de permissão, até ES2022, está disponível em funções personalizadas. 
   </td>
   </tr>
   </tr>
   <tr>
