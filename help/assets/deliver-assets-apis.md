...
Todos [ativos aprovados](approved-assets.md) disponível no repositório do Experience Manager assets pode ser [pesquisado](search-assets-api.md) e depois entregue aos aplicativos downstream integrados usando um URL de entrega.
