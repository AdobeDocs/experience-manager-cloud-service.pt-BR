...
* Se a variável [!UICONTROL Relatório de uso do disco] não gera e se estiver usando [!DNL Dynamic Media], certifique-se de que todos os ativos sejam processados corretamente. Para resolver, reprocesse os ativos e gere o relatório novamente.
