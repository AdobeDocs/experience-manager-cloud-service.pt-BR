...
|----|----|----|------|-----|-----|
| Métodos de implantação | Adequado [!DNL Assets] oferta. | Assets Essentials | Cloud Service, Adobe Managed Services, no local | Serviço em nuvem |
| **Geral** |
