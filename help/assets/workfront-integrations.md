...
Adobe ofertas para [integrar [!DNL Workfront] e [!DNL Adobe Experience Manager Assets] nativamente (com suporte para Assets Essentials e Assets as a Cloud Service)](https://experienceleague.adobe.com/docs/workfront/using/documents/wf-aem-integrations/wf-aem-essentials/aem-asset-integrations.html).
