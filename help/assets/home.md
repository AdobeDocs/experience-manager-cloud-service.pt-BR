---
title: Ativos Adobe Experience Manager como Cloud Service
description: Recursos de autoajuda e links de documentação do Ativos Adobe Experience Manager como Cloud Service
translation-type: ht
...
# Ativos AEM como Cloud Service {#aem-assets-guide}

Esta página lista os recursos de autoajuda sobre ativos como Cloud Service.

## Artigos-chave sobre ativos como Cloud Service {#key-articles}

* [Introdução aos ativos como Cloud Service](overview.md)
* [Arquitetura de ativos como Cloud Service](architecture.md)
