...
>[!IMPORTANT]
>
> * O Brand Portal está no modo de manutenção. Todas as inovações de produtos estão disponíveis no [Centro de conteúdo](/help/assets/product-overview.md).
