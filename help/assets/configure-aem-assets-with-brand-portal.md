...
Você pode criar uma nova configuração em E/S da Adobe para configurar os ativos AEM com o Portal de marcas.
...
* [Publicar ativos do AEM Assets no Brand Portal](publish-to-brand-portal.md#publish-assets-to-bp)
...
A distribuição contém os seguintes registros:
