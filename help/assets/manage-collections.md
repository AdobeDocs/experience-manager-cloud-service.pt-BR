...
Para abrir o **[!UICONTROL Coleções]** toque ou clique no logotipo do Experience Manager. Na página de navegação, acesse **[!UICONTROL Assets]** > **[!UICONTROL Coleções]**.
...
1. Arraste os ativos para a **[!UICONTROL Soltar na coleção]** zona. Como alternativa, toque/clique no link **[!UICONTROL Para a coleção]** ícone na barra de ferramentas.
...
1. Insira a palavra-chave de pesquisa na caixa Omni Search e selecione `Enter`. Toque/clique no ícone Navegação global para exibir o painel Filtros e aplicar um filtro de pesquisa a partir do painel Pesquisar.
1. No **[!UICONTROL Arquivos e pastas]** selecione **[!UICONTROL Arquivos]**.
1. Toque/clique **[!UICONTROL Salvar conjunto inteligente]**.
...
1. Selecione o ativo e toque/clique no **[!UICONTROL Para a coleção]** ícone na barra de ferramentas. Como alternativa, você pode arrastar o ativo para a **[!UICONTROL Soltar na coleção]** zona. Solte o botão do mouse quando a área de soltar se tornar ativa e seu rótulo mudar para **[!UICONTROL Soltar para adicionar]**.
1. No **[!UICONTROL Adicionar à coleção]** selecione a coleção à qual deseja adicionar o ativo.
1. Toque/clique **[!UICONTROL Adicionar]** e feche a mensagem de confirmação. O ativo é adicionado à coleção.
...
1. Na interface do Assets, toque/clique no link **[!UICONTROL Pesquisar]** ícone na barra de ferramentas.
...
1. Toque/clique **[!UICONTROL Salvar]**. A variável **[!UICONTROL Editar coleção inteligente]** será exibida.
...
1. Na caixa de diálogo de confirmação, toque/clique **[!UICONTROL Salvar]** para concluir o processo.
...
1. No console Coleções, selecione uma coleção e toque/clique no **[!UICONTROL Propriedades]** ícone na barra de ferramentas.
...
1. Na barra de ferramentas, toque/clique no **[!UICONTROL Propriedades]** ícone.
...
1. Selecione uma coleção e toque/clique no **[!UICONTROL Configurações]** na barra de ferramentas. Como alternativa, use o **[!UICONTROL Configurações]** ação rápida da miniatura da coleção.
...
1. Na caixa de diálogo, toque/clique **[!UICONTROL Excluir]** para confirmar a ação de exclusão.
...
1. Na barra de ferramentas, toque/clique **[!UICONTROL Propriedades]** para abrir o [!UICONTROL Propriedades] página das coleções selecionadas.
...
1. No console Coleções, selecione a coleção ou o grupo de coleções desejado e toque ou clique **[!UICONTROL Para a coleção]** na barra de ferramentas.
...
1. Toque/clique **[!UICONTROL Adicionar]**. Uma mensagem confirma que a coleção é adicionada à coleção de público alvo na variável **[!UICONTROL Selecionar destino]** página. Feche a mensagem para concluir o processo.
...
1. Na caixa de diálogo, toque/clique **[!UICONTROL Excluir]** para excluir a pesquisa salva.
...
1. Na linha do tempo, selecione ou toque no ícone Cursor na parte inferior e toque/clique **[!UICONTROL Iniciar fluxo de trabalho]**.
...
1. Insira um título para o fluxo de trabalho e toque/clique **[!UICONTROL Início]**.
1. Na caixa de diálogo, toque/clique **[!UICONTROL Continuar]**. O fluxo de trabalho é executado em todos os ativos na coleção.
