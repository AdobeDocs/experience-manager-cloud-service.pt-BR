...
### Desativação de Workflows {#disabling-workflows}
...
### Ativação de ativos {#activating-assets}
...
1. No caminho raiz do armazenamento de dados, localize e exclua todos os arquivos **do repositório-XXX** .
...
### Ativação de Workflows {#enabling-workflows}
...
1. Migre tags.
   ...
   Como as tags já foram carregadas na instância do AEM de origem, é possível criá-las em um pacote de conteúdo e instalá-las na instância do público alvo.
...
1. Ativando workflows.

   Após concluir a migração, ative novamente os iniciadores para os workflows de ativos de atualização do DAM para suportar a geração de execução e a extração de metadados para uso diário do sistema.
