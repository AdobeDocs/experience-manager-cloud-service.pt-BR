...
description: Use ativos disponíveis em uma implantação remota [!DNL Adobe Experience Manager Assets] ao criar suas páginas da Web em outra implantação do [!DNL Adobe Experience Manager Sites].
contentOwner: AG
