...
* A criação de uma versão não é compatível com o Dynamic Media. A nova versão substituirá o ativo existente na entrega.
    ...
    <ol>
     ...
     <li>Selecione as seguintes ações em ordem:
      <ol>
       ...
       <li>Desmarque a pasta Predefinição (abaixo de <code>/conf</code>).
       <li>Acionar Tarefa Assíncrona de Configuração do DM.</li>
      </ol> </li>
     <li>Aguarde a notificação de sincronização bem-sucedida na Caixa de entrada de AEM.
     </li>
    </ol> </td>
  </tr>
 </tbody>
