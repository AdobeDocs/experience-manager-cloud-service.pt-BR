...
1. Dependendo do tipo de ativo que você clicou, siga um destes procedimentos:
   ...
   <table>
    <tbody>
      ...
      <li>Para retornar a imagem ao mapa de zoom original, toque em <strong>Redefinir</strong>.</li>
      <li>Para maximizar o visualizador no dispositivo de exibição, toque em <strong>Tela cheia</strong>.</li>
      </ul>
