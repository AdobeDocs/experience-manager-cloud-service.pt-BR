...
* A extensão do Adobe Analytics estende a lista de ações compatíveis com duas ações necessárias para enviar dados aos servidores de rastreamento: *Defina Variáveis* e *Enviar beacon*.
...
Por exemplo, `https://ims-na1.adobelogin.com/`(o nome do servidor de exemplo é apenas para fins ilustrativos)   ![2019-07-25_15-01-53](assets/2019-07-25_15-01-53.png)
]**`https://ims-na1.adobelogin.com/`

   _Página de detalhes da integração - guia JWT_   **[!UICONTROL Chave da API]** - Retorne à página de detalhes da integração. Clique na guia **[!UICONTROL Visão geral]** e, à direita do campo **[!UICONTROL Chave da API (ID do cliente)]**, clique em **[!UICONTROL Copiar]**._
...
1. Retorne à página **[!UICONTROL Conta]** e cole a chave no respectivo campo.************
   ...
   _Página de detalhes da integração_   **[!UICONTROL Segredo do cliente]** - Retorne à página Detalhes da integração. Na guia **[!UICONTROL Visão geral]**, clique em **[!UICONTROL Recuperar segredo do cliente]**. À direita do campo **[!UICONTROL Segredo do cliente]**, clique em **[!UICONTROL Copiar]**._
...
1. Retorne à página **[!UICONTROL Conta]** e cole o código no respectivo campo.****
   ...
   _Página de detalhes da integração - guia JWT_   _A página Conta, com todos os campos preenchidos, será semelhante ao seguinte:_
...
## No autor de AEM, próximo ao canto superior esquerdo, clique no ícone Ferramentas (martelo) e, em seguida, clique em Serviços **[!UICONTROL em nuvem > Configurações]** do Adobe Launch.
...
1. ![image2019-7-15_15-47-6](assets/image2019-7-15_15-47-6.png)]**
   ...
   ![Atualmente, o autor do AEM não oferece suporte à integração de visualizadores de mídia dinâmica com o Adobe Launch.](assets/image2019-7-15_15-47-6.png)
...
Consulte [Integrar o AEM ao Adobe Launch via E/S[#$tu398] da Adobe para obter mais informações sobre como configurar a Configuração da Adobe Launch Cloud.
