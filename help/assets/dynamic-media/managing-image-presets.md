...
No AEM as a Cloud Service, as representações são geradas usando os **Microsserviços de ativos**. O fluxo de trabalho do Ativo de atualização do DAM não está disponível para personalização no Cloud Service.
