...
1. Quando a conexão for bem-sucedida, você poderá definir o seguinte:
   ...
   |---|---|
   | Empresa | O nome da conta do Dynamic Media. Você pode ter uma conta Dynamic Media no Experience Manager.<!-- CQDOC-19579 and CQDOC-19612 --><br>Consulte também [Configurar uma conta de alias de empresa do Dynamic Media](/help/assets/dynamic-media/dm-alias-account.md). |
