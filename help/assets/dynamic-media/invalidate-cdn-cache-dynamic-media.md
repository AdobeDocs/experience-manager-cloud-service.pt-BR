...
Se você habilitou [Smart Imaging](/help/assets/dynamic-media/imaging-faq.md) em sua conta e está usando o CDN agrupado em Adobe, é possível limpar todos os URLs com diferentes cadeias de caracteres de consulta, limpando o URL de base única.
