...
Para ver um vídeo interativo e que pode ser comprado, selecione [Demonstrações ao vivo](https://landing.adobe.com/en/na/dynamic-media/ctir-2755/live-demos.html), role até o cabeçalho **[!UICONTROL Mídia que pode ser comprada]** na página e selecione o vídeo que pode ser comprado para iniciar a reprodução.
...
>[!NOTE]
>
>Se você criar um vídeo interativo para iniciar uma página da Web quando um usuário selecionar uma imagem em miniatura, alguns dispositivos bloqueiam a abertura da página da Web pop-up. Nesses casos, altere a configuração do bloqueador de pop-ups no dispositivo. Por exemplo, em um iPhone 6 da Apple, vá para **[!UICONTROL Settings]** > **[!UICONTROL Safari]** > **[!UICONTROL Bloquear pop-ups]** e, em seguida, deslize o controle para **[!UICONTROL Off]**. Agora, ao reproduzir um vídeo interativo e selecionar uma miniatura, você será solicitado a abrir a janela pop-up. Se você aceitar, a página da Web será aberta.
...
O webinar [Usar vídeo interativo, Compartilhamento de link e YouTube no Experience Manager Assets](https://adobecustomersuccess.adobeconnect.com/p1yxzdo4aec/) ensina como usar o vídeo interativo e outros recursos para unir eventos orientados por conversão ao conteúdo de marketing por vídeo.
...
Se você carregou os vídeos ou imagens errados, ou quiser excluir os vídeos ou imagens carregados que não são mais necessários, consulte [Excluir ativos](/help/assets/manage-digital-assets.md#delete-assets).
...
1. Siga um destes procedimentos:
   <table> 
    <tbody> 
      ...
      <td>Em um segmento de linha do tempo, selecione uma imagem em miniatura que tenha um link de cadeia à direita de seu rótulo de texto. O link de cadeia indica que uma ação foi atribuída a ela. Para fazer as alterações, selecione a guia <strong>Actions</strong>.</td> 
      </tr> 
      <tr> 
...
1. Próximo ao canto superior direito da página **[!UICONTROL Criar vídeo interativo]**, o nome da predefinição do visualizador selecionado no momento, usada com o vídeo, é exibido. Para selecionar uma predefinição de visualizador diferente, selecione o nome.
