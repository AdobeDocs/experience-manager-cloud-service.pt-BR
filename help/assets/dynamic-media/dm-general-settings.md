...
| --- | --- |
| **[!UICONTROL Valor]** | Obrigatório.<br>Ele controla a quantidade de contraste aplicada aos pixels de borda.<br>Pense nisso como a intensidade do efeito. Os valores de intensidade de Tirar nitidez da máscara diferem entre o Adobe Dynamic Media e o Adobe Photoshop. A Photoshop oferece um intervalo de valores de 1% a 500%. Enquanto no Adobe Dynamic Media, o intervalo de valores é de `0.0` a `5.0`. Um valor de 5,0 no Adobe Dynamic Media é o equivalente aproximado de 500% no Photoshop; um valor de 0,9 é o equivalente de 90% e assim por diante. |
