...
Trabalhar com o Dynamic Media não está disponível na interface do usuário clássica. Consulte [Trabalhar com mídias dinâmicas](/help/assets/dynamic-media/dynamic-media.md), que abrange a interface do usuário habilitada para toque.
