...
* [Ativação da proteção de hotlink na mídia dinâmica](/help/assets/dynamic-media/hotlink-protection.md)
...
* [Entrega HTTP2 de conteúdo](/help/assets/dynamic-media/http2faq.md)
...
Consulte [HTTP/2 Entrega de Perguntas](/help/assets/dynamic-media/http2faq.md) frequentes sobre conteúdo para saber mais.
