...
1. [Criar Conjuntos de rotação.](#creating-spin-sets)
   ...
   >[!NOTE]
   >
   >Também é possível criar conjuntos de rotação automaticamente por meio de predefinições [de conjuntos de](/help/assets/dynamic-media/config-dm.md#creating-batch-set-presets-to-auto-generate-image-sets-and-spin-sets)lotes. **** Importante:Os conjuntos de lotes são criados pelo IPS (Image Production System) como parte da ingestão de ativos.
...
1. [Vincule URLs ao aplicativo](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md) da Web ou [Incorpore o visualizador](/help/assets/dynamic-media/embed-code.md)de vídeo ou imagem.
   ...
   Consulte [Vincular um conjunto de rotação a uma página](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md) da Web e [Incorporar o visualizador](/help/assets/dynamic-media/embed-code.md)de vídeo ou imagem.

Se necessário, é possível [editar Conjuntos](#editing-spin-sets)de rotação. Além disso, você pode exibir e modificar as propriedades [do Conjunto de](/help/assets/manage-digital-assets.md#editing-properties)rotação.
...
>[!NOTE]
>
>Também é possível criar conjuntos de rotação automaticamente por meio de predefinições [de conjuntos de](/help/assets/dynamic-media/config-dm.md)lotes. **** Importante:Os conjuntos de lotes são criados pelo IPS (Image Production System) como parte da ingestão de ativos.
>
