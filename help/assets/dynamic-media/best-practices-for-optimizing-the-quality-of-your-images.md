...
* O JPG comprime a uma proporção de 10:1 e geralmente produz tamanhos de arquivo de imagem menores. O PNG é compactado em uma proporção de aproximadamente 2:1, exceto quando as imagens contêm um fundo branco. Normalmente, porém, os tamanhos dos arquivos PNG são maiores que os arquivos JPG.
...
* White paper sobre práticas recomendadas [Práticas recomendadas de qualidade e nitidez da imagem do Adobe Dynamic Media Classic](/help/assets/dynamic-media/assets/sharpening_images.pdf) também se aplica ao Experience Manager.

* Observar [Usar a nitidez da imagem com o Experience Manager - Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-image-sharpening-feature-video-use.html#dynamic-media).
...
* O Experience Manager também oferece formas mais avançadas de ajustar a qualidade da imagem, como aplicar imagens de nitidez na assimilação. Para ajustar e otimizar os resultados de renderização, [Serviços Adobe](https://business.adobe.com/customers/consulting-services/main.html) O pode ajudá-lo com informações personalizadas e práticas recomendadas.
