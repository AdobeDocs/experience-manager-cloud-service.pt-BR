...
1. Opcional: [Crie uma predefinição](/help/assets/dynamic-media/managing-viewer-presets.md)do visualizador Conjunto de carrossel, conforme necessário.
...
1. [Adicione pontos de acesso ou mapas de imagem a um banner de imagem.](#adding-hotspots-or-image-maps-to-an-image-banner)
   ...
   Consulte [(Opcional) Visualização de banners de carrossel.](#optional-previewing-carousel-banners) - Opcional. Se desejar, você pode exibir uma representação do conjunto de carrossel e testar sua interatividade.
...
Se precisar editar Conjuntos de carrossel, consulte [edição de Conjuntos de carrossel.](#editing-carousel-sets) Além disso, você pode exibir e editar as propriedades [do Conjunto de](/help/assets/manage-digital-assets.md#editing-properties)carrossel.
