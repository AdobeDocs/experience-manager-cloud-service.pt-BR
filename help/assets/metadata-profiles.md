...
1. Toque no logotipo AEM e navegue até **[!UICONTROL Ferramentas > Ativos > Perfis de metadados]** e, em seguida, toque em **[!UICONTROL Criar]**.
1. Digite um título para o Perfil Metadados, por exemplo Metadados de amostra, e toque em **[!UICONTROL Enviar]**. O formulário Editar para o Perfil de Metadados é exibido.
...
1. Toque em **[!UICONTROL Concluído]**. O Perfil Metadados é adicionado à lista de perfis na página **[!UICONTROL Perfis de metadados]**.
...
Você pode reprocessar ativos em uma pasta que já tenha um perfil de metadados existente que você tenha alterado posteriormente. <!-- See [Reprocessing assets in a folder after you have edited its processing profile](processing-profiles.md#reprocessing-assets-in-a-folder-after-you-have-edited-its-processing-profile). -->
...
* Navegue até `https://<AEM server>/mnt/overlay/dam/gui/content/assets/foldersharewizard.html/content/dam` e aplique o perfil apropriado e toque **Salvar**.
...
## Removendo um perfil de metadados das pastas {#removing-a-metadata-profile-from-folders}
...
### Remoção de perfis de metadados de pastas por meio da interface de usuário de Perfis {#removing-metadata-profiles-from-folders-via-profiles-user-interface}

1. Toque ou clique no logotipo AEM e navegue até **[!UICONTROL Ferramentas > Ativos > Perfis de metadados]**.
