...
description: O novo Visualizador de vídeo no Dynamic Media fornece uma experiência de reprodução de vídeo aprimorada
role: User
exl-id: null
...
O Novo Visualizador de Vídeo está disponível a partir do **AEM como Cloud Service versão 2025.7.0**.
...
2. Arraste o componente **Dynamic Media** para o local necessário na página.
...
![Arrastar componente do Dynamic Media](assets/drag-component.jpeg)
...
A carga do evento inclui informações como o tipo e o estado da reprodução, a hora atual de reprodução e metadados adicionais. Esses eventos podem ser usados para oferecer suporte ao rastreamento de análises, interações personalizadas ou integração com sistemas externos
...
+++Se um usuário retrocede e assiste novamente partes do vídeo, isso aumenta a contagem video_views, engagement_score ou ambos?

Assistir novamente partes do vídeo não aumenta a contagem de video_views. A reprodução adicional contribui para o engagement_score.

+++

+++Se o mesmo usuário assiste ao mesmo vídeo várias vezes sem recarregar a página, como as visualizações de vídeo e a pontuação do engajamento são calculadas?

A reprodução repetida sem recarregar a página não aumenta a contagem de video_views. A reprodução adicional contribui para o engagement_score.

+++

+++Pausar e retomar um vídeo afeta o controle de engajamento ou o cálculo da taxa de conclusão?
