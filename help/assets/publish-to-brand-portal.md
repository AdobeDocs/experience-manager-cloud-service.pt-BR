...
1. Veja a seguir as duas maneiras de publicar ativos:
   ...
   * [Publicar mais tarde](#publish-to-bp-later) (agendar ativos de publicação)
...
* Na barra de ferramentas, selecione Publicação **[!UICONTROL rápida]**. Em seguida, no menu, clique em **[!UICONTROL Publicar no Brand Portal]**.
...
1. Selecione os ativos que deseja agendar para publicação e clique em **[!UICONTROL Gerenciar publicação]** na barra de ferramentas na parte superior.

1. Na página **[!UICONTROL Gerenciar publicação]** , selecione **[!UICONTROL Publicar no portal]** da marca no **[!UICONTROL Action]**.
...
1. **Publicar pastas agora**
   ...
   * Na barra de ferramentas, selecione Publicação **[!UICONTROL rápida]**.
...
Você pode remover qualquer pasta de ativos publicada no Brand Portal, desfazendo a publicação da instância de ativos AEM. Após desfazer a publicação da pasta original, a cópia não estará mais disponível para os usuários do Brand Portal.
...
1. No console Ativos, selecione as pastas de ativos que deseja publicar e clique na opção **[!UICONTROL Gerenciar publicação]** na barra de ferramentas.

   ![publish2bp-1](assets/publish2bp.png)

1. **Cancelar a publicação de pastas de ativos agora**

   Para cancelar a publicação imediata da pasta de ativos selecionada no Portal de marcas:
   ...
   1. Confirme sua seleção no **[!UICONTROL Escopo]** e clique em **[!UICONTROL Cancelar publicação no Portal]** da marca.

      ![confirmar-desfazer a publicação](assets/confirm-unpublish.png)

1. **Cancelar a publicação de pastas de ativos mais tarde**

   Para agendar a despublicação de uma pasta de ativos para uma data e hora posteriores:
   ...
   1. Confirme sua seleção no **[!UICONTROL Escopo]** e clique em **[!UICONTROL Avançar]**.

   1. Especifique um título **[!UICONTROL de]** Fluxo de trabalho em **[!UICONTROL Workflows]**. Clique em **[!UICONTROL Cancelar publicação mais tarde]**.
...
>[!NOTE]
>
>Os fragmentos de conteúdo não podem ser publicados no Brand Portal. Portanto, se você selecionar fragmentos de conteúdo nos ativos AEM, a ação **[!UICONTROL Publicar no portal]** da marca não estará disponível.
>
