...
* A Adobe recomenda adicionar até 1000 ativos em cada pasta no [!DNL Experience Manager Assets]. Se você tentar fazer isso, poderá receber uma mensagem de alerta dizendo: &quot;Este diretório contém mais de 1000 itens. Os uploads e as novas criações de pasta podem ser adiadas.&quot; Embora ainda seja possível adicionar mais ativos a uma pasta, você pode enfrentar problemas de desempenho, como a navegação mais lenta para essas pastas.
