---
title: Usar o Supervisor de conteúdo para acessar conteúdo AEM em aplicativos Adobe e não-Adobe
description: O Content Advisor oferece uma experiência unificada de detecção de conteúdo em aplicativos Adobe e não-Adobe, além de proporcionar detecção inteligente e sensível ao contexto diretamente na experiência de criação.
...
# Usar o Supervisor de conteúdo para acessar conteúdo do AEM em aplicativos Adobe e não Adobe{#content-advisor-aem-assets-adobe-non-Adobe-applications}

O Content Advisor oferece uma experiência unificada de detecção de conteúdo em aplicativos Adobe e não Adobe. Integrado nativamente a aplicativos como Adobe Workfront, AJO B2C (em breve), AEM Sites e outros que não sejam da Adobe, o Content Advisor reúne o conteúdo (ativos e fragmentos de conteúdo) em uma única interface inteligente. Ele permite que você descubra, navegue e reutilize facilmente o conteúdo mais relevante, diretamente do seu fluxo de trabalho, para que possa se mover mais rápido sem quebrar o contexto.
...
Isso permite descobrir, avaliar e usar ativos aprovados da AEM Assets diretamente em seus aplicativos externos, mantendo a consistência com a experiência disponível no Adobe Express e em outros aplicativos da Adobe.

Para obter mais informações sobre integrações, propriedades e personalizações, consulte os seguintes artigos:

* [Exemplos de integração do Supervisor de conteúdo](https://github.com/adobe/aem-assets-selectors-mfe-examples/tree/consolidate-docs-to-experience-league/examples)

* [Propriedades do Supervisor de Conteúdo](/help/assets/content-advisor-properties.md)

* [Personalizações do Supervisor de conteúdo](/help/assets/content-advisor-customization.md)
