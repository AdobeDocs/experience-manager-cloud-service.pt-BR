...
|---|---|---|---|
| `fileName` | Sequência de caracteres | Obrigatório | O nome do ativo, conforme fornecido pelos dados de iniciação. |
| `mimeType` | Sequência de caracteres | Obrigatório | O tipo de conteúdo HTTP do binário, como foi fornecido pelos dados de iniciação. |
| `uploadToken` | Sequência de caracteres | Obrigatório | Token de upload para o binário, conforme fornecido pelos dados de iniciação. |
