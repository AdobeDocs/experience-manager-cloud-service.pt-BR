...
1. Tap/click the **[!UICONTROL Publish]** icon from the toolbar. Se você não conseguir ver o ícone **Publicar** na barra de ferramentas, toque/clique em **[!UICONTROL Mais]** na barra de ferramentas e localize o ícone **[!UICONTROL Publicar]** .
