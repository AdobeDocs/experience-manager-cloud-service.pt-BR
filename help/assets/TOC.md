...
+ [Alterações importantes no [!DNL Assets] como [!DNL Cloud Service]](assets-cloud-changes.md)
...
+ Gerenciar ativos digitais {#manage}
   ...
   + [Use [!DNL Adobe Stock] ativos](aem-assets-adobe-stock.md)
...
+ Configurar, administrar e estender [!DNL Assets] {#admin}
   ...
   + [Gerar para representações somente posicionamento](configure-fpo-renditions.md)
...
+ Dynamic Media {#dynamicmedia}
   ...
   + [Opcional - Definir Dynamic Media, Configurações Gerais](dynamic-media/dm-general-settings.md)
   + [Opcional - Configurar o Dynamic Media, Configuração de publicação](dynamic-media/dm-publish-settings.md)
