...
A data de lançamento da versão mais recente 1.9.8 do [!DNL Workfront for Experience Manager enhanced connector] O é em 3 de março de 2023.
...
>[!IMPORTANT]
>
>O Adobe recomenda que você [atualização para a versão 1.9.8 mais recente](../assets/update-workfront-enhanced-connector.md) do [!DNL Workfront for Experience Manager enhanced connector].
