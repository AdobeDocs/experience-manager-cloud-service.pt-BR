...
A versão mais recente do [!DNL Workfront for Experience Manager enhanced connector] inclui as atualizações:
...
[!DNL Workfront for Experience Manager enhanced connector] A versão 1.9.7, lançada em 20 de fevereiro de 2023, inclui as seguintes atualizações:
