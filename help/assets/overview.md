---
title: Introdução aos ativos como a [!DNL Cloud Service]
description: Novidades do Assets como  [!DNL Cloud Service].
contentOwner: AG
...
Para começar, entenda os [benefícios de uma oferta nativa de nuvem](#solution-benefits). Confira as alterações notáveis [para AEM como  [!DNL Cloud Service]](/help/release-notes/aem-cloud-changes.md) que também afetam os Experience Manager Assets acompanharam as alterações notáveis [nos Ativos](/help/assets/assets-cloud-changes.md).
...
A seguir estão os principais benefícios dos Ativos como [!DNL Cloud Service]. Para saber mais, consulte [visão geral do Experience Manager como a [!DNL Cloud Service]](/help/overview/introduction.md).

* **Serviços em nuvem modernos para processamento** de ativos: Os novos microserviços de ativos são um serviço de processamento de ativos baseado em nuvem, dimensionável, confiável e sem complicações.
