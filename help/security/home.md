---
title: Segurança do Adobe Experience Manager como Cloud Service
description: Recursos de autoajuda e links de documentação da segurança do Adobe Experience Manager como Cloud Service
translation-type: ht
...
# Segurança do Experience Manager como Cloud Service {#aem-security-guide}

Esta página lista os recursos de autoajuda sobre segurança do Experience Manager como Cloud Service.

## Artigos-chave sobre segurança {#key-articles}

* [Suporte IMS do AEM como Cloud Service](ims-support.md)
