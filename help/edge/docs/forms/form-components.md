---
title: Serviço de entrega de borda do AEM Forms
...
O Bloco de formulário ajuda a criar formulários facilmente para capturar e armazenar dados capturados. Ele suporta componentes baseados em todos os HTML [tipos de entrada](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#input_types) como texto, email, número, data e muito mais. Também suporta [textarea](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea), [selecionar](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/select), e [fieldset](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/fieldset) e inclui recursos de validação de entrada nativos do HTML5.

O Bloco de formulário gera uma estrutura de HTML uniforme para todos os tipos de campo e containers (painéis), garantindo a consistência. Essa estrutura consistente facilita a [estilizar um formulário](/help/edge/docs/forms/style-theme-forms.md).


## Propriedades dos componentes

As seguintes propriedades são compatíveis com componentes de formulário do Bloco de formulário:

<table>
 <tbody>
  <tr>
   <td><b>Propriedade</b> </td>
   <td><b>Componentes de formulário (Tipo de entrada)</b> </td>
   <td><b>Detalhes</b></td>
  </tr>
  <tr>
   <td>Nome</td>
   <td>Todos os componentes</td>
   <td> Uma string que especifica um nome para o componente. Os dados do componente são enviados com este nome.
   </td>
  </tr>
  <tr>
   <td>Rótulo</td>
   <td>Todos os componentes</td>
   <td> O rótulo serve como legenda do campo.
   </td>
  </tr>
  <tr>
   <td>Valor</td>
   <td>Todos os componentes</td>
   <td> O valor inicial do controle. Para os componentes de rádio e caixa de seleção, esse é o valor/dado que é enviado quando eles são selecionados. O atributo value é sempre opcional, embora deva ser considerado obrigatório para a caixa de seleção e o rádio.
   </td>
  </tr>
    <tr>
