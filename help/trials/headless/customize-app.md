...
1. Selecione o **X** para remover a imagem do motociclista. A imagem desaparece e o editor mostra um erro, pois a imagem é um dado obrigatório para este modelo de fragmento de conteúdo.
...
1. Selecione a imagem `biker-yellow.png` e selecione **Selecionar**.
