...
1. Depois de definir as propriedades do campo, é possível alternar de volta para a guia **Tipos de dados** no painel direito e adicionar campos adicionais arrastando e soltando.

Dessa forma, é possível adicionar quantos campos forem necessários ao seu modelo para suportar qualquer tipo de estrutura de dados necessária. Os tipos de campos de dados variam, mas o processo de adicioná-los ao modelo permanece o mesmo.

Prossiga para a próxima seção para adicionar os campos necessários para concluir e salvar o modelo da **Aventura**
...
1. Adicione um campo para armazenar a descrição da aventura, arrastando e soltando um campo **Texto multilinha**, e insira as seguintes propriedades:
...
1. Adicione um campo para armazenar uma imagem que represente a viagem. As imagens no AEM são armazenadas como outro tipo de conteúdo chamado **Ativos**. Assim, para criar um campo para elas, é necessário arrastar e soltar um campo **Referência de conteúdo** que referenciará o ativo da imagem.
