...
Neste módulo, você criará um novo Fragmento de conteúdo com base nesse modelo, usando o console Fragmento de conteúdo . Pense no console de fragmentos de conteúdo como uma biblioteca de conteúdo headless. Use-o para criar novos fragmentos de conteúdo e gerenciar fragmentos existentes.
...
1. No **Modelo do fragmento de conteúdo** , selecione o **Aventura** Modelo de Fragmento de conteúdo criado anteriormente.

1. Adicionar `Tuscany` como uma descrição **Título** para o Fragmento do conteúdo. Isso é para identificar o fragmento no console.
...
>[!TIP]
>
>Dependendo das configurações do navegador, a nova guia do navegador pode ser suprimida por um bloqueador de pop-up. Se o novo fragmento não abrir depois de clicar **Criar e abrir**, verifique as configurações do navegador.

## Adicionar conteúdo ao fragmento do conteúdo {#add-content}
...
1. Forneça uma **Preço** para o fragmento, inserindo `$700`.

1. Forneça uma **Imagem** que seja representativo da viagem tocando ou clicando em **Adicionar ativo** no **Imagem** campo.

1. Na janela pop-up do ativo, toque ou clique **Procurar ativos** para selecionar de um ativo existente na biblioteca de ativos.

   ![Adicionar ativo](assets/do-not-localize/add-asset.png)

1. O **Selecionar ativo** será aberta. Usando o navegador em árvore no painel esquerdo, navegue até **Todos os ativos** > **aem-demo-assets** > **en** > **aventuras** > **ciclismo-Toscana**.

1. O conteúdo do **ciclismo-Toscana** são exibidas à direita. Selecione a imagem `ADOBESTOCK_141786166.JPEG`.
