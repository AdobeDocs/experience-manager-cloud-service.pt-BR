...
>[!TIP]
>
>Perfis de permissões personalizadas com permissões configuráveis também estão disponíveis. Consulte o documento [Permissões personalizadas](/help/implementing/cloud-manager/custom-permissions.md) para mais detalhes.
