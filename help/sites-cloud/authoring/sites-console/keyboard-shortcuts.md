...
|  | `/` | Executar a [pesquisa](/help/sites-cloud/authoring/search.md) |
|  | `Alt+`&lt;`Number`> | Alternar para a opção de [seletor do painel](/help/sites-cloud/authoring/basic-handling.md#rail-selector) que deseja exibir |
|  | ``` ` ``` | Ocultar painel |
|  | `e` | Editar |
|  | `p` | Propriedades |
|  | `m` | Mover |
...
* [Minhas preferências](/help/sites-cloud/authoring/account-environment.md#my-preferences)
* No [menu de ajuda](/help/sites-cloud/authoring/basic-handling.md#accessing-help)
