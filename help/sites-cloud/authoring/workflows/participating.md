...
* Seu indicador de [notificação](/help/sites-cloud/authoring/getting-started/inbox.md) (barra de ferramentas) será incrementado:
   ...
   ![Barra de ferramentas de notificação](/help/sites-cloud/authoring/assets/workflows-notifications.png)
...
* Quando [abrir um item de fluxo de trabalho para detalhes da visualização](#opening-a-workflow-item-to-view-details-and-take-actions).
...
1. Selecione a página desejada e abra **Linha do tempo** (ou abra **Linha do tempo** e selecione a página):
   ...
   ![Concluindo uma etapa](/help/sites-cloud/authoring/assets/workflows-timeline-completing.png)

1. Clique/toque no banner de alerta para mostrar as ações disponíveis. Selecione **Avançar**:

   ![Avançando a etapa](/help/sites-cloud/authoring/assets/workflows-timeline-advance.png)
...
1. Clique/toque no banner de alerta para mostrar as ações disponíveis. Selecione **Alterar administrador**:
   ...
   ![Etapa delegada](/help/sites-cloud/authoring/assets/workflows-delegate.png)
...
* **INFORMAÇÕES** DO FLUXO DE TRABALHOtab:
   ...
   ![Etapas do fluxo de trabalho](/help/sites-cloud/authoring/assets/workflows-workflow-stages.png)
