...
>[!NOTE]
>
>Algumas ações também serão mostradas na [exibição de cartão do recurso apropriado](/help/sites-cloud/authoring/basic-handling.md#card-view).
...
>[!NOTE]
>
>A caixa de entrada funciona como um console, portanto, use [Navegação global](/help/sites-cloud/authoring/basic-handling.md#global-navigation) ou [Pesquisar](/help/sites-cloud/authoring/search.md) para navegar para outro local quando terminar.
