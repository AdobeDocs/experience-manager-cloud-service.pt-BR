...
![Configurações do usuário](/help/sites-cloud/authoring/assets/user-settings.png)
...
* **Habilitar atalhos**
   ...
   * [Atalhos de teclado para a edição de páginas](/help/sites-cloud/authoring/fundamentals/keyboard-shortcuts.md)
