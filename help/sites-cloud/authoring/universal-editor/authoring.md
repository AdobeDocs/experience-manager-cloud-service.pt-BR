...
1. Use o [**Sites** console](/help/sites-cloud/authoring/sites-console/introduction.md) para navegar até a página criada para uso com o Editor universal que você deseja editar.
1. Editar a página.
1. O Editor universal é aberto para editar a página selecionada.

>[!NOTE]
>
>Ao editar uma página no [**Sites** console,](/help/sites-cloud/authoring/sites-console/introduction.md) o console abrirá o editor apropriado para a página [modelo:](/help/sites-cloud/authoring/sites-console/templates.md) o Editor Universal descrito neste documento ou a variável [editor de página.](/help/sites-cloud/authoring/page-editor/introduction.md)

### Acesso Direto {#accessing-directly}

1. Faça logon no Editor universal. Você precisa de uma Adobe ID para entrar e [ter acesso ao Universal Editor.](/help/implementing/universal-editor/getting-started.md#request-access)
...
>[!NOTE]
>
>Qualquer página que você deseja editar com o Editor universal deve ser [instrumentado para suportar o Editor universal.](/help/implementing/universal-editor/getting-started.md)
