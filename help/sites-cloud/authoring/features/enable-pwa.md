...
Em vez de exigir qualquer gravação do site, um autor de conteúdo pode configurar as propriedades de PWA como uma guia adicional nas [propriedades de página](/help/sites-cloud/authoring/fundamentals/page-properties.md) de um site.
...
1. Selecione o projeto do seu site e selecione [**Propriedades**](/help/sites-cloud/authoring/fundamentals/page-properties.md) ou use a tecla de atalho `p`.
