...
É possível navegar entre os consoles usando o painel de navegação global. Isso é acionado como um menu suspenso de tela inteira ao selecionar o link **Adobe Experience Manager** no canto superior esquerdo da tela.
...
| Sites | [O console Sites](/help/sites-cloud/authoring/sites-console/introduction.md) permite criar, exibir e gerenciar sites em execução na sua instância do AEM. Por meio desse console, você pode criar, copiar, mover e excluir páginas, iniciar fluxos de trabalho e publicar páginas. |
...
| Gerar variações | [Gerar variações](/help/generative-ai/generate-variations.md) usa a Inteligência Artificial (AI) gerativa para criar variações de conteúdo com base em prompts; esses prompts são fornecidos pela Adobe ou criados e gerenciados pelos usuários. |

## Painel Ferramentas {#tools-panel}

O painel **Ferramentas** tem um painel lateral que contém um intervalo de categorias, que agrupa consoles semelhantes. Os consoles **Ferramentas** fornecem acesso a várias ferramentas e consoles especializados que ajudam a administrar seus sites, ativos digitais e outros aspectos do seu repositório de conteúdo.
...
* [Navegação Global](#global-navigation) - Selecione o link **Adobe Experience Manager** para navegar entre consoles.

  ![Navegação global](/help/sites-cloud/authoring/assets/basic-handling-global-navigation.png)

* Feedback

  ![Botão de comentários](/help/sites-cloud/authoring/assets/basic-handling-feedback.png)
...
* [Pesquisa](/help/sites-cloud/authoring/search.md) - Você também pode usar a [tecla de atalho](/help/sites-cloud/authoring/sites-console/keyboard-shortcuts.md) `/` (barra) para invocar a pesquisa de qualquer console.
...
* [Notificações](/help/sites-cloud/authoring/inbox.md) -   Esse ícone contém o número de notificações incompletas atribuídas atualmente.

  ![Botão Notificações](/help/sites-cloud/authoring/assets/basic-handling-notifications.png)

* [Propriedades do Usuário](/help/sites-cloud/authoring/account-environment.md) - Selecione esta opção para alterar suas configurações de usuário.
...
* **Barra de Ferramentas** - Dependendo da sua localização, o ícone **Ajuda** abre os recursos apropriados:
...
* **Console de Ferramentas** - No console **Ferramentas**, também é possível acessar os **Recursos** externos:
