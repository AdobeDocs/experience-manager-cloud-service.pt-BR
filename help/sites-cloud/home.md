...
Esta página fornece uma lista completa de todos os recursos de suporte dos serviços na nuvem do AEM. Obtenha respostas para suas perguntas sobre o [!DNL AEM Sites as a Cloud Service].
...
| [Notas de versão](/help/release-notes/home.md) | Este guia fornece informações importantes sobre a versão mais recente do Experience Manager as a Cloud Service, incluindo as novidades, os recursos obsoletos ou removidos e os problemas conhecidos. |
