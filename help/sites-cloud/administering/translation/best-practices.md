...
Criar ou expandir uma presença global na Web pode ser um processo complexo, mas com boas previsões e planejamento, o AEM pode simplificar seus esforços e apoiar suas metas globais de negócios.
...
* Se o seu idioma mestre tiver variações globais, uma opção é usar o MSM para criar uma live copy a partir do mestre global para usar na tradução. Por exemplo, se a criação global for realizada em um mestre em inglês dos EUA, crie um mestre em inglês internacional como uma live copy e a base para a tradução para outros idiomas.
* Use o MSM para criar sites de países a partir dos mestres de idioma traduzido e implantar conteúdo em sites que compartilhem o mesmo idioma. Por exemplo, o mestre em língua francesa pode ser distribuído para sites da França, Bélgica e Suíça.
...
* Envolva um **provedor de serviços de localização (LSP)** com conhecimento em tradução e atividades relacionadas de localização. Os LSPs podem ajudar a ampliar seus negócios globais fornecendo uma ampla variedade de recursos e tecnologias para melhorar a eficiência e economizar custos de tradução:
   ...
   * O **AEM Translation Framework** oferece suporte à integração com uma variedade de provedores de tecnologia de tradução para tradução automática e humana.
   * Saiba como [integrar conectores LSP em seu sistema AEM](integration-framework.md) para automatizar a tradução de conteúdo, ou como criar, exportar e importar manualmente Projetos de tradução para teste e nos casos em que não há LSP ou provedor de tecnologia de tradução.
...
* Confie na experiência dos provedores de serviços de localização, da Adobe Consulting e dos Integradores de sistemas para planejar, protótipo e testar sua estrutura de site multilíngue.
