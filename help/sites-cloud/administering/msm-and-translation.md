...
O Gerenciador multisite e as ferramentas de tradução integradas do Adobe Experience Manager simplificam a localização do conteúdo.
...
* O gerenciador de vários sites (MSM) e seus recursos de Live Copy permitem usar o conteúdo do mesmo site em vários locais, permitindo variações:
   * [Reutilizar conteúdo: Gerenciador multisite e Live Copy](msm/overview.md)
...
É possível criar conteúdo para sites multinacionais e multilíngues com eficiência usando o Gerenciador multisite e o fluxo de trabalho de tradução.
...
>[!TIP]
>
>Limite o uso do Gerenciador multisite para conteúdo em um único idioma.
>
