...
* Verifique a [Artigo de práticas recomendadas do MSM](best-practices.md) como algumas dicas são apresentadas, juntamente com esclarecimentos sobre vários equívocos.
...
Para evitar isso, use a Live Copy **Suspender** em vez de **Desanexar**. Mais detalhes sobre a **Desanexar** ação em [este artigo.](creating-live-copies.md)
