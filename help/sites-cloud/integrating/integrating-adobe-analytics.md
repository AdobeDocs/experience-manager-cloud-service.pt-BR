...
* usar a interface de toque para criar uma configuração do Analytics no AEM as a Cloud Service. Observe que a autenticação IMS é necessária para integrar o Adobe Analytics com AEM as a Cloud Service.
