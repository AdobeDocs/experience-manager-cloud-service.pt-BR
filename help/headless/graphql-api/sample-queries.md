...
>[!NOTE]
>
>Várias consultas fazem referência à variação `variation1`. Isso não está no pacote WKND padrão. Ele deve ser criado para teste.
>
>If `variation1` não existe, então a variável `master`será retornada como padrão.
