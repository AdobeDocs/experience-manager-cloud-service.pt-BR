...
O curinga `*` abre vários endpoints na instância do AEM. A consulta usando um endpoint do GraphQL é feita usando `POST` e a resposta será **não** ser armazenado em cache.
