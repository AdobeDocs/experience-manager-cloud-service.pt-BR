...
>
>Se você é novo no AEM ou no headless, consulte Jornada AEM de documentação do Adobe Headless para obter uma introdução completa sobre headless e como o oferece suporte a ele.
>
...
* **Administradores** A deve definir a configuração inicial e a estrutura de pastas para o conteúdo normalmente apenas uma vez, ou esporadicamente.
* **Arquitetos de informações** em geral, adicione novos modelos à medida que as necessidades da organização evoluem.
* **Autores de conteúdo** criar conteúdo continuamente como fragmentos de conteúdo com base nos modelos definidos pelos arquitetos.
